...
namespace VehiclesControl
{
	...
	public class Humvee04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee04.InverseTransformDirection(_humvee04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _humvee04.GetComponent<Rigidbody>().velocity.magnitude;
