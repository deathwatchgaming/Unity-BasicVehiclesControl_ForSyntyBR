...
namespace VehiclesControl
{
	...
	public class Humvee06Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee06.InverseTransformDirection(_humvee06.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _humvee06.GetComponent<Rigidbody>().velocity.magnitude;
