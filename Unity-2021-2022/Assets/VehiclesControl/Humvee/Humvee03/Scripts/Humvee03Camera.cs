...
namespace VehiclesControl
{
	...
	public class Humvee03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee03.InverseTransformDirection(_humvee03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _humvee03.GetComponent<Rigidbody>().velocity.magnitude;
