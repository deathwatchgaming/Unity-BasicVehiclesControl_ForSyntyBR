...
namespace VehiclesControl
{
	...
	public class SixWheelTruck06Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck06.InverseTransformDirection(_sixWheelTruck06.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sixWheelTruck06.GetComponent<Rigidbody>().velocity.magnitude;
