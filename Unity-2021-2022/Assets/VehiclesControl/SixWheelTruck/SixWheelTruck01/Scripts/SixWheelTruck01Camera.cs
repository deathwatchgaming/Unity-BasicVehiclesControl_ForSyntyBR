...
namespace VehiclesControl
{
	...
	public class SixWheelTruck01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck01.InverseTransformDirection(_sixWheelTruck01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sixWheelTruck01.GetComponent<Rigidbody>().velocity.magnitude;
