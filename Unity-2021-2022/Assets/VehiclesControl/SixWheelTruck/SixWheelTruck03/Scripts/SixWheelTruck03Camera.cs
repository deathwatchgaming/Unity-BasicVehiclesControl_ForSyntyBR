...
namespace VehiclesControl
{
	...
	public class SixWheelTruck03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck03.InverseTransformDirection(_sixWheelTruck03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sixWheelTruck03.GetComponent<Rigidbody>().velocity.magnitude;
