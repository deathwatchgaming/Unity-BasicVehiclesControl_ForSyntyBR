...
namespace VehiclesControl
{
	...
	public class SixWheelTruck05Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck05.InverseTransformDirection(_sixWheelTruck05.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sixWheelTruck05.GetComponent<Rigidbody>().velocity.magnitude;
