...
namespace VehiclesControl
{
	...
	public class SixWheelTruck04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck04.InverseTransformDirection(_sixWheelTruck04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sixWheelTruck04.GetComponent<Rigidbody>().velocity.magnitude;
