...
namespace VehiclesControl
{
	...
	public class TankUS02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankUS02.InverseTransformDirection(_tankUS02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankUS02.GetComponent<Rigidbody>().velocity.magnitude;
