...
namespace VehiclesControl
{
	...
	public class TankUS04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankUS04.InverseTransformDirection(_tankUS04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankUS04.GetComponent<Rigidbody>().velocity.magnitude;
