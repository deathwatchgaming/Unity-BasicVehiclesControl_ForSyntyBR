/*
 * File: TankUS 03 Only Speedometer
 * Name: TankUS03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankUS03OnlySpeedUnit
	public enum TankUS03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankUS03OnlySpeedUnit

	// public class TankUS03OnlySpeedometer 
	public class TankUS03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankUS03OnlySpeedUnit _speedUnit	
			[SerializeField] private TankUS03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankUS03OnlySpeedUnit.mph
			if (_speedUnit == TankUS03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankUS03OnlySpeedUnit.mph
	...
	} // close public class TankUS03OnlySpeedometer
