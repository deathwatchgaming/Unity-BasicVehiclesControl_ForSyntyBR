...
namespace VehiclesControl
{
	...
	public class TankUS01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankUS01.InverseTransformDirection(_tankUS01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankUS01.GetComponent<Rigidbody>().velocity.magnitude;
