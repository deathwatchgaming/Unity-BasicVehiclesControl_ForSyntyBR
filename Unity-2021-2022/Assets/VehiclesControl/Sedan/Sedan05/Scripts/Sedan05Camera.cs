...
namespace VehiclesControl
{
	...
	public class Sedan05Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan05.InverseTransformDirection(_sedan05.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedan05.GetComponent<Rigidbody>().velocity.magnitude;
