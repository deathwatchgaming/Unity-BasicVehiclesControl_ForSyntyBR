...
namespace VehiclesControl
{
	...
	public class Sedan04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan04.InverseTransformDirection(_sedan04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedan04.GetComponent<Rigidbody>().velocity.magnitude;
