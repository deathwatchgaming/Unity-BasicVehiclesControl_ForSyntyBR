...
namespace VehiclesControl
{
	...
	public class Sedan01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan01.InverseTransformDirection(_sedan01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedan01.GetComponent<Rigidbody>().velocity.magnitude;
