...
namespace VehiclesControl
{
	...
	public class ArmoredTruck05Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck05.InverseTransformDirection(_armoredTruck05.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _armoredTruck05.GetComponent<Rigidbody>().velocity.magnitude;
