/*
 * File: Armored Truck 02 Only Speedometer
 * Name: ArmoredTruck02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck02OnlySpeedUnit
	public enum ArmoredTruck02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck02OnlySpeedUnit

	// public class ArmoredTruck02OnlySpeedometer 
	public class ArmoredTruck02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck02OnlySpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals ArmoredTruck02OnlySpeedUnit.mph
			if (_speedUnit == ArmoredTruck02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck02OnlySpeedUnit.mph
	...
	} // close public class ArmoredTruck02OnlySpeedometer
