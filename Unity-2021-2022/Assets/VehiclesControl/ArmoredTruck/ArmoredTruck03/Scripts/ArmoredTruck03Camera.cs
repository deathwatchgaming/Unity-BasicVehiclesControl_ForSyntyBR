...
namespace VehiclesControl
{
	...
	public class ArmoredTruck03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck03.InverseTransformDirection(_armoredTruck03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _armoredTruck03.GetComponent<Rigidbody>().velocity.magnitude;
