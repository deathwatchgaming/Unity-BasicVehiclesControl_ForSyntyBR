...
namespace VehiclesControl
{
	...
	public class ArmoredTruck04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck04.InverseTransformDirection(_armoredTruck04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _armoredTruck04.GetComponent<Rigidbody>().velocity.magnitude;
