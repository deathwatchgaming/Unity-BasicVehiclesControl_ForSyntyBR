...
namespace VehiclesControl
{
	...
	public class TankRU04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankRU04.InverseTransformDirection(_tankRU04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankRU04.GetComponent<Rigidbody>().velocity.magnitude;
