...
namespace VehiclesControl
{
	...
	public class TankRU01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankRU01.InverseTransformDirection(_tankRU01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankRU01.GetComponent<Rigidbody>().velocity.magnitude;
