...
namespace VehiclesControl
{
	...
	public class DuneBuggy01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _duneBuggy01.InverseTransformDirection(_duneBuggy01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _duneBuggy01.GetComponent<Rigidbody>().velocity.magnitude;
