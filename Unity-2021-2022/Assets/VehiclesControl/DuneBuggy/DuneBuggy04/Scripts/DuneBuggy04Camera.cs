...
namespace VehiclesControl
{
	...
	public class DuneBuggy04Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _duneBuggy04.InverseTransformDirection(_duneBuggy04.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _duneBuggy04.GetComponent<Rigidbody>().velocity.magnitude;
