...
namespace VehiclesControl
{
	...
	public class DuneBuggy02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _duneBuggy02.InverseTransformDirection(_duneBuggy02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _duneBuggy02.GetComponent<Rigidbody>().velocity.magnitude;
