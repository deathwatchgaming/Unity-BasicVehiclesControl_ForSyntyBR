/*
*  Name: Six Wheel Truck 04 Compass
*  File: SixWheelTruck04Compass.cs
...
namespace NavigationControl
{
	// public class SixWheelTruck04Compass
	public class SixWheelTruck04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SixWheelTruck04 transform")]
		...
		// SixWheelTruck04Compass _sixWheelTruck04Compass
		public static SixWheelTruck04Compass _sixWheelTruck04Compass;

		// private void Start
		private void Start()
		{
			// _sixWheelTruck04Compass
			_sixWheelTruck04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SixWheelTruck04Compass is enabled
				GetComponent<SixWheelTruck04Compass>().enabled = true;

				// Debug Log SixWheelTruck04 compass is enabled
				//Debug.Log("The SixWheelTruck04 compass is enabled");
			...
			{
				// Debug Log SixWheelTruck04 compass is disabled
				//Debug.Log("The SixWheelTruck04 compass is disabled");
				...
				// Get Component SixWheelTruck04Compass is not enabled
				GetComponent<SixWheelTruck04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sixWheelTruck04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sixWheelTruck04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sixWheelTruck04 forward vector

			// Vector3 forward is _sixWheelTruck04 transform forward
			Vector3 forward = _sixWheelTruck04.transform.forward;

			// Zero out the Y of _sixWheelTruck04 forward vector to only get the direction in the X,Z 
	...
	} // close public class SixWheelTruck04Compass
