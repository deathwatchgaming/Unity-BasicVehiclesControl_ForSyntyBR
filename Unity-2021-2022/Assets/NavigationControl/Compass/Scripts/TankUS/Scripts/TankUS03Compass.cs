/*
*  Name: Tank US 03 Compass
*  File: TankUS03Compass.cs
...
namespace NavigationControl
{
	// public class TankUS03Compass
	public class TankUS03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankUS03 transform")]
			// Transform _tankUS03
			[SerializeField] private Transform _tankUS03;
		...
		// TankUS03Compass _tankUS03Compass
		public static TankUS03Compass _tankUS03Compass;

		// private void Start
		private void Start()
		{
			// _tankUS03Compass
			_tankUS03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankUS03Compass is enabled
				GetComponent<TankUS03Compass>().enabled = true;

				// Debug Log TankUS03 compass is enabled
				//Debug.Log("The TankUS03 compass is enabled");
			...
			{
				// Debug Log TankUS03 compass is disabled
				//Debug.Log("The TankUS03 compass is disabled");
				...
				// Get Component TankUS03Compass is not enabled
				GetComponent<TankUS03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankUS03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankUS03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankUS03 forward vector

			// Vector3 forward is _tankUS03 transform forward
			Vector3 forward = _tankUS03.transform.forward;

			// Zero out the Y of _tankUS03 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankUS03Compass
