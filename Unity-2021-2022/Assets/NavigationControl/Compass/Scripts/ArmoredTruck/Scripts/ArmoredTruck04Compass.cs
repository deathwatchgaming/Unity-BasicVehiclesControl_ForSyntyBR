/*
*  Name: Armored Truck 04 Compass
*  File: ArmoredTruck04Compass.cs
...
namespace NavigationControl
{
	// public class ArmoredTruck04Compass
	public class ArmoredTruck04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The ArmoredTruck04 transform")]
			// Transform _armoredTruck04
			[SerializeField] private Transform _armoredTruck04;
		...
		public static ArmoredTruck04Compass _armoredTruck04Compass;

		// private void Start
		private void Start()
		{
			// _armoredTruck04Compass
			_armoredTruck04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component ArmoredTruck04Compass is enabled
				GetComponent<ArmoredTruck04Compass>().enabled = true;

				// Debug Log ArmoredTruck04 compass is enabled
			...
			{
				// Debug Log ArmoredTruck04 compass is disabled
				...
				// Get Component ArmoredTruck04Compass is not enabled
				GetComponent<ArmoredTruck04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _armoredTruck04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_armoredTruck04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _armoredTruck04 forward vector

			// Vector3 forward is _armoredTruck04 transform forward
			Vector3 forward = _armoredTruck04.transform.forward;

			// Zero out the Y of _armoredTruck04 forward vector to only get the direction in the X,Z 
	...
	} // close public class ArmoredTruck04Compass
