/*
*  Name: Armored Truck 06 Compass
*  File: ArmoredTruck06Compass.cs
...
namespace NavigationControl
{
	// public class ArmoredTruck06Compass
	public class ArmoredTruck06Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The ArmoredTruck06 transform")]
			// Transform _armoredTruck06
			[SerializeField] private Transform _armoredTruck06;
		...
		public static ArmoredTruck06Compass _armoredTruck06Compass;

		// private void Start
		private void Start()
		{
			// _armoredTruck06Compass
			_armoredTruck06Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component ArmoredTruck06Compass is enabled
				GetComponent<ArmoredTruck06Compass>().enabled = true;

				// Debug Log ArmoredTruck06 compass is enabled
			...
			{
				// Debug Log ArmoredTruck06 compass is disabled
				...
				// Get Component ArmoredTruck06Compass is not enabled
				GetComponent<ArmoredTruck06Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _armoredTruck06 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_armoredTruck06.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _armoredTruck06 forward vector

			// Vector3 forward is _armoredTruck06 transform forward
			Vector3 forward = _armoredTruck06.transform.forward;

			// Zero out the Y of _armoredTruck06 forward vector to only get the direction in the X,Z 
	...
	} // close public class ArmoredTruck06Compass
