/*
*  Name: Dune Buggy 01 Compass
*  File: DuneBuggy01Compass.cs
...
namespace NavigationControl
{
	// public class DuneBuggy01Compass
	public class DuneBuggy01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The DuneBuggy01 transform")]
			// Transform _duneBuggy01
			[SerializeField] private Transform _duneBuggy01;
		...
		public static DuneBuggy01Compass _duneBuggy01Compass;

		// private void Start
		private void Start()
		{
			// _duneBuggy01Compass
			_duneBuggy01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component DuneBuggy01Compass is enabled
				GetComponent<DuneBuggy01Compass>().enabled = true;

				// Debug Log DuneBuggy01 compass is enabled
			...
			{
				// Debug Log DuneBuggy01 compass is disabled
				...
				// Get Component DuneBuggy01Compass is not enabled
				GetComponent<DuneBuggy01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _duneBuggy01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_duneBuggy01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _duneBuggy01 forward vector

			// Vector3 forward is _duneBuggy01 transform forward
			Vector3 forward = _duneBuggy01.transform.forward;

			// Zero out the Y of _duneBuggy01 forward vector to only get the direction in the X,Z 
	...
	} // close public class DuneBuggy01Compass
