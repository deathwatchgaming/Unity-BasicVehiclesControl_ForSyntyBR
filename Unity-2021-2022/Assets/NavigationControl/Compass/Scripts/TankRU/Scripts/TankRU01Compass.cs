/*
*  Name: Tank RU 01 Compass
*  File: TankRU01Compass.cs
...
namespace NavigationControl
{
	// public class TankRU01Compass
	public class TankRU01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankRU01 transform")]
			// Transform _tankRU01
			[SerializeField] private Transform _tankRU01;
		...
		// TankRU01Compass _tankRU01Compass
		public static TankRU01Compass _tankRU01Compass;

		// private void Start
		private void Start()
		{
			// _tankRU01Compass
			_tankRU01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankRU01Compass is enabled
				GetComponent<TankRU01Compass>().enabled = true;

				// Debug Log TankRU01 compass is enabled
				//Debug.Log("The TankRU01 compass is enabled");
			...
			{
				// Debug Log TankRU01 compass is disabled
				//Debug.Log("The TankRU01 compass is disabled");
				...
				// Get Component TankRU01Compass is not enabled
				GetComponent<TankRU01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankRU01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankRU01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankRU01 forward vector

			// Vector3 forward is _tankRU01 transform forward
			Vector3 forward = _tankRU01.transform.forward;

			// Zero out the Y of _tankRU01 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankRU01Compass
