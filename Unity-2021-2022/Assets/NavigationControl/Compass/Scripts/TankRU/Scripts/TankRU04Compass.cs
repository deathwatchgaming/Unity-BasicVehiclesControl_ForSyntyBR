/*
*  Name: Tank RU 04 Compass
*  File: TankRU04Compass.cs
...
namespace NavigationControl
{
	// public class TankRU04Compass
	public class TankRU04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankRU04 transform")]
			// Transform _tankRU04
		...
		public static TankRU04Compass _tankRU04Compass;

		// private void Start
		private void Start()
		{
			// _tankRU04Compass
			_tankRU04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankRU04Compass is enabled
				GetComponent<TankRU04Compass>().enabled = true;

				// Debug Log TankRU04 compass is enabled
			...
			{
				// Debug Log TankRU04 compass is disabled
				...
				// Get Component TankRU04Compass is not enabled
				GetComponent<TankRU04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankRU04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankRU04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankRU04 forward vector

			// Vector3 forward is _tankRU04 transform forward
			Vector3 forward = _tankRU04.transform.forward;

			// Zero out the Y of _tankRU04 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankRU04Compass
