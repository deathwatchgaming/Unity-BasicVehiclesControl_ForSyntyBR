/*
*  Name: Tank RU 06 Compass
*  File: TankRU06Compass.cs
...
namespace NavigationControl
{
	// public class TankRU06Compass
	public class TankRU06Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankRU06 transform")]
			// Transform _tankRU06
		...
		// TankRU06Compass _tankRU06Compass
		public static TankRU06Compass _tankRU06Compass;

		// private void Start
		private void Start()
		{
			// _tankRU06Compass
			_tankRU06Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankRU06Compass is enabled
				GetComponent<TankRU06Compass>().enabled = true;

				// Debug Log TankRU06 compass is enabled
				//Debug.Log("The TankRU06 compass is enabled");
			...
			{
				// Debug Log TankRU06 compass is disabled
				//Debug.Log("The TankRU06 compass is disabled");
				...
				// Get Component TankRU06Compass is not enabled
				GetComponent<TankRU06Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankRU06 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankRU06.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankRU06 forward vector

			// Vector3 forward is _tankRU06 transform forward
			Vector3 forward = _tankRU06.transform.forward;

			// Zero out the Y of _tankRU06 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankRU06Compass
