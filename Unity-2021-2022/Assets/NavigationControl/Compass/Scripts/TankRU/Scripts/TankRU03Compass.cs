/*
*  Name: Tank RU 03 Compass
*  File: TankRU03Compass.cs
...
namespace NavigationControl
{
	// public class TankRU03Compass
	public class TankRU03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankRU03 transform")]
			// Transform _tankRU03
			[SerializeField] private Transform _tankRU03;
		...
		// TankRU03Compass _tankRU03Compass
		public static TankRU03Compass _tankRU03Compass;

		// private void Start
		private void Start()
		{
			// _tankRU03Compass
			_tankRU03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankRU03Compass is enabled
				GetComponent<TankRU03Compass>().enabled = true;

				// Debug Log TankRU03 compass is enabled
				//Debug.Log("The TankRU03 compass is enabled");
			...
			{
				// Debug Log TankRU03 compass is disabled
				//Debug.Log("The TankRU03 compass is disabled");
				...
				// Get Component TankRU03Compass is not enabled
				GetComponent<TankRU03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankRU03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankRU03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankRU03 forward vector

			// Vector3 forward is _tankRU03 transform forward
			Vector3 forward = _tankRU03.transform.forward;

			// Zero out the Y of _tankRU03 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankRU03Compass
