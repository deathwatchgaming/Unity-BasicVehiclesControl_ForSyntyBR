/*
*  Name: Sedan 03 Compass
*  File: Sedan03Compass.cs
...
namespace NavigationControl
{
	// public class Sedan03Compass
	public class Sedan03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Sedan03 transform")]
			// Transform _sedan03
			[SerializeField] private Transform _sedan03;
		...
		public static Sedan03Compass _sedan03Compass;

		// private void Start
		private void Start()
		{
			// _sedan03Compass
			_sedan03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Sedan03Compass is enabled
				GetComponent<Sedan03Compass>().enabled = true;

				// Debug Log Sedan03 compass is enabled
			...
			{
				// Debug Log Sedan03 compass is disabled
				...
				// Get Component Sedan03Compass is not enabled
				GetComponent<Sedan03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedan03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedan03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedan03 forward vector

			// Vector3 forward is _sedan03 transform forward
			Vector3 forward = _sedan03.transform.forward;

			// Zero out the Y of _sedan03 forward vector to only get the direction in the X,Z 
	...
	} // close public class Sedan03Compass
