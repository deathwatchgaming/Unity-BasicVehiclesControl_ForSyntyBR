/*
*  Name: Sedan 01 Compass
*  File: Sedan01Compass.cs
...
namespace NavigationControl
{
	// public class Sedan01Compass
	public class Sedan01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Sedan01 transform")]
			// Transform _sedan01
			[SerializeField] private Transform _sedan01;
		...
		public static Sedan01Compass _sedan01Compass;

		// private void Start
		private void Start()
		{
			// _sedan01Compass
			_sedan01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Sedan01Compass is enabled
				GetComponent<Sedan01Compass>().enabled = true;

				// Debug Log Sedan01 compass is enabled
			...
			{
				// Debug Log Sedan01 compass is disabled
				...
				// Get Component Sedan01Compass is not enabled
				GetComponent<Sedan01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedan01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedan01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedan01 forward vector

			// Vector3 forward is _sedan01 transform forward
			Vector3 forward = _sedan01.transform.forward;

			// Zero out the Y of _sedan01 forward vector to only get the direction in the X,Z 
	...
	} // close public class Sedan01Compass
