/*
*  Name: Humvee 01 Compass
*  File: Humvee01Compass.cs
...
namespace NavigationControl
{
	// public class Humvee01Compass
	public class Humvee01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Humvee01 transform")]
			// Transform _humvee01
			[SerializeField] private Transform _humvee01;
		...
		public static Humvee01Compass _humvee01Compass;

		// private void Start
		private void Start()
		{
			// _humvee01Compass
			_humvee01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Humvee01Compass is enabled
				GetComponent<Humvee01Compass>().enabled = true;

				// Debug Log Humvee01 compass is enabled
			...
			{
				// Debug Log Humvee01 compass is disabled
				...
				// Get Component Humvee01Compass is not enabled
				GetComponent<Humvee01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _humvee01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_humvee01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _humvee01 forward vector

			// Vector3 forward is _humvee01 transform forward
			Vector3 forward = _humvee01.transform.forward;

			// Zero out the Y of _humvee01 forward vector to only get the direction in the X,Z 
	...
	} // close public class Humvee01Compass
