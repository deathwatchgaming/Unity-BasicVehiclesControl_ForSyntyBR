/*
*  Name: Humvee 02 Compass
*  File: Humvee02Compass.cs
...
namespace NavigationControl
{
	// public class Humvee02Compass
	public class Humvee02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Humvee02 transform")]
			// Transform _humvee02
			[SerializeField] private Transform _humvee02;
		...
		public static Humvee02Compass _humvee02Compass;

		// private void Start
		private void Start()
		{
			// _humvee02Compass
			_humvee02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Humvee02Compass is enabled
				GetComponent<Humvee02Compass>().enabled = true;

				// Debug Log Humvee02 compass is enabled
			...
			{
				// Debug Log Humvee02 compass is disabled
				...
				// Get Component Humvee02Compass is not enabled
				GetComponent<Humvee02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _humvee02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_humvee02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _humvee02 forward vector

			// Vector3 forward is _humvee02 transform forward
			Vector3 forward = _humvee02.transform.forward;

			// Zero out the Y of _humvee02 forward vector to only get the direction in the X,Z 
	...
	} // close public class Humvee02Compass
