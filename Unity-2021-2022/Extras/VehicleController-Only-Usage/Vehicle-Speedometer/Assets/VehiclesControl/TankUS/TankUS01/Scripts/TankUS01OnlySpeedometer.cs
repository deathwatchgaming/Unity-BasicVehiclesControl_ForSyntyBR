/*
 * File: TankUS 01 Only Speedometer
 * Name: TankUS01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankUS01OnlySpeedUnit
	public enum TankUS01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankUS01OnlySpeedUnit

	// public class TankUS01OnlySpeedometer 
	public class TankUS01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankUS01OnlySpeedUnit _speedUnit	
			[SerializeField] private TankUS01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankUS01OnlySpeedUnit.mph
			if (_speedUnit == TankUS01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankUS01OnlySpeedUnit.mph
	...
	} // close public class TankUS01OnlySpeedometer
