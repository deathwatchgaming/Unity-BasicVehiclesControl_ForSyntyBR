/*
 * File: Sedan 02 Only Speedometer
 * Name: Sedan02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan02OnlySpeedUnit
	public enum Sedan02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan02OnlySpeedUnit

	// public class Sedan02OnlySpeedometer 
	public class Sedan02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan02OnlySpeedUnit _speedUnit	
			[SerializeField] private Sedan02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Sedan02OnlySpeedUnit.mph
			if (_speedUnit == Sedan02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan02OnlySpeedUnit.mph
	...
	} // close public class Sedan02OnlySpeedometer
