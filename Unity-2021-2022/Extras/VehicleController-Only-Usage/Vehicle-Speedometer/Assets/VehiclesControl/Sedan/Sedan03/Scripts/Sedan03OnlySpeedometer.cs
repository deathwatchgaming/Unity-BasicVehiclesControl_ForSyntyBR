/*
 * File: Sedan 03 Online Speedometer
 * Name: Sedan03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan03OnlySpeedUnit
	public enum Sedan03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan03OnlySpeedUnit

	// public class Sedan03OnlySpeedometer 
	public class Sedan03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan03OnlySpeedUnit _speedUnit	
			[SerializeField] private Sedan03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Sedan03OnlySpeedUnit.mph
			if (_speedUnit == Sedan03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan03OnlySpeedUnit.mph
	...
	} // close public class Sedan03OnlySpeedometer
