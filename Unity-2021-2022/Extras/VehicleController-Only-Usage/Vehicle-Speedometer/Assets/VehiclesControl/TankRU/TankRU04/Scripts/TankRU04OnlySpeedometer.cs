/*
 * File: TankRU 04 Only Speedometer
 * Name: TankRU04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU04OnlySpeedUnit
	public enum TankRU04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU04OnlySpeedUnit

	// public class TankRU04OnlySpeedometer 
	public class TankRU04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU04OnlySpeedUnit _speedUnit	
			[SerializeField] private TankRU04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankRU04OnlySpeedUnit.mph
			if (_speedUnit == TankRU04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU04OnlySpeedUnit.mph
	...
	} // close public class TankRU04OnlySpeedometer
