/*
 * File: Armored Truck 04 Only Speedometer
 * Name: ArmoredTruck04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck04OnlySpeedUnit
	public enum ArmoredTruck04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck04OnlySpeedUnit

	// public class ArmoredTruck04OnlySpeedometer 
	public class ArmoredTruck04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck04OnlySpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals ArmoredTruck04OnlySpeedUnit.mph
			if (_speedUnit == ArmoredTruck04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck04OnlySpeedUnit.mph
	...
	} // close public class ArmoredTruck04OnlySpeedometer
