/*
 * File: Six Wheel Truck 02 Only Speedometer
 * Name: SixWheelTruck02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SixWheelTruck02OnlySpeedUnit
	public enum SixWheelTruck02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck02OnlySpeedUnit

	// public class SixWheelTruck02OnlySpeedometer 
	public class SixWheelTruck02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck02OnlySpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SixWheelTruck02OnlySpeedUnit.mph
			if (_speedUnit == SixWheelTruck02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck02OnlySpeedUnit.mph
	...
	} // close public class SixWheelTruck02OnlySpeedometer
