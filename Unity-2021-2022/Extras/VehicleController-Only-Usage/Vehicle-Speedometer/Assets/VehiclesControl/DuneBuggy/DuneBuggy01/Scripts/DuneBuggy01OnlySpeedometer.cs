/*
 * File: Dune Buggy 01 Only Speedometer
 * Name: DuneBuggy01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy01OnlySpeedUnit
	public enum DuneBuggy01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy01OnlySpeedUnit

	// public class DuneBuggy01OnlySpeedometer 
	public class DuneBuggy01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy01OnlySpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals DuneBuggy01OnlySpeedUnit.mph
			if (_speedUnit == DuneBuggy01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy01OnlySpeedUnit.mph
	...
	} // close public class DuneBuggy01OnlySpeedometer
