/*
 * File: TankRU Speedometer
 * Name: TankRUSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRUSpeedUnit
	public enum TankRUSpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRUSpeedUnit

	// public class TankRUSpeedometer 
	public class TankRUSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRUSpeedUnit _speedUnit	
			[SerializeField] private TankRUSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankRU_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankRU_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankRU_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankRU_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankRU_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankRU_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankRUSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankRUSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals TankRUSpeedUnit.mph
			if (_speedUnit == TankRUSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRUSpeedUnit.mph
	...
	} // close public class TankRUSpeedometer
