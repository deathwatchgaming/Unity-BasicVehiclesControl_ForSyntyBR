...
namespace VehiclesControl
{
    ...
    {  
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName ArmoredTruck_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("ArmoredTruck_EntryKey");
