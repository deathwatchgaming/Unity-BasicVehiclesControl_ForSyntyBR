/*
 * File: ArmoredTruck Speedometer
 * Name: ArmoredTruckSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruckSpeedUnit
	public enum ArmoredTruckSpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruckSpeedUnit

	// public class ArmoredTruckSpeedometer 
	public class ArmoredTruckSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruckSpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruckSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName ArmoredTruck_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("ArmoredTruck_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName ArmoredTruck_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("ArmoredTruck_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName ArmoredTruck_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("ArmoredTruck_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName ArmoredTruckSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("ArmoredTruckSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals ArmoredTruckSpeedUnit.mph
			if (_speedUnit == ArmoredTruckSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruckSpeedUnit.mph
			...
			// if _inArmoredTruck and Input GetKey KeyCode _exitKey
			if (_inArmoredTruck && Input.GetKey(_exitKey))
			{
				// _inArmoredTruck is false
				_inArmoredTruck = false;

			} // close if _inArmoredTruck and Input GetKey KeyCode _exitKey
		...
		private void OnTriggerStay(Collider other)
		{
			...
			// if not _inArmoredTruck and gameObject tag is Player and Input GetKey KeyCode _enterKey
			...
			} // close if not _inArmoredTruck and gameObject tag is Player and Input GetKey KeyCode _enterKey
	...
	} // close public class ArmoredTruckSpeedometer
