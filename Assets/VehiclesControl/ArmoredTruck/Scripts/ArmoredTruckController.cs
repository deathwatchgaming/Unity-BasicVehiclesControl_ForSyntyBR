...
namespace VehiclesControl
{
	// public enum ArmoredTruckSpeedType
	public enum ArmoredTruckSpeedType
	{
		mph,
		kmh	

	} // close public enum ArmoredTruckSpeedType
	...
	public class ArmoredTruckController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// ArmoredTruckSpeedType _speedType	
			[SerializeField] private ArmoredTruckSpeedType _speedType;			
		...
		private void Update()
		{
			...
			// _speedType equals ArmoredTruckSpeedType.mph
			if (_speedType == ArmoredTruckSpeedType.mph)
			{
				// _speed
				_speed *= 2.23694f;
			...
			} // close if _speedType equals ArmoredTruckSpeedType.mph

			// else if _speedType equals ArmoredTruckSpeedType.kmh
			else if (_speedType == ArmoredTruckSpeedType.kmh)
			{
				// _speed
				_speed *= 3.6f;
			...
			} // close else if _speedType equals ArmoredTruckSpeedType.kmh
