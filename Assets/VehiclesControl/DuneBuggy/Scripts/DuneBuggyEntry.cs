...
namespace VehiclesControl
{
    ...
    public class DuneBuggyEntry : MonoBehaviour
    {
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName DuneBuggy_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("DuneBuggy_EntryKey");
