...
namespace VehiclesControl
{
    ...
    {   
        ...
        private void Start() 
        {
            ...
            // GameObject _interfaceTextObject is FindInActiveObjectByName SixWheelTruck_EntryKey
            GameObject _interfaceTextObject = FindInActiveObjectByName("SixWheelTruck_EntryKey");
