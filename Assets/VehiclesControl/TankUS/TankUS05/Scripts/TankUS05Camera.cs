...
namespace VehiclesControl
{
	...
	public class TankUS05Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankUS05.InverseTransformDirection(_tankUS05.GetComponent<Rigidbody>().velocity);
			...
			// float acc is_tankUS05 GetComponent Rigidbody velocity magnitude
			float _acc = _tankUS05.GetComponent<Rigidbody>().velocity.magnitude;
