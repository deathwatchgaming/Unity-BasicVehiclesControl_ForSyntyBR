/*
 * File: TankUS Controller
 * Name: TankUSController.cs
...
namespace VehiclesControl
{
	...
	// public class TankUSController
	public class TankUSController : MonoBehaviour
	{
		...
		[Header("TankUS Transforms")]
			...
			// _tankUSBody
			[SerializeField] private Transform _tankUSBody;

			[Tooltip("The tank turret transform")]	    
			// _tankUSTurret						
			[SerializeField] private Transform _tankUSTurret;

			[Tooltip("The tank turret transform")]	    
			// _tankUSBarrel					
			[SerializeField] private Transform _tankUSBarrel;			
		...
		[Header("Amounts")]
			...
			// _tankUSRotationSpeed is 0.35
			[SerializeField] private float _tankUSRotationSpeed = 0.35f;
		...
		private void Awake()
		{
			...
			// _tankUSTurretRotation is _tankUSTurret.transform.eulerAngles
			_tankUSTurretRotation = _tankUSTurret.transform.eulerAngles;
