/*
 * File: TankUS Speedometer
 * Name: TankUSSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankUSSpeedUnit
	public enum TankUSSpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankUSSpeedUnit

	// public class TankUSSpeedometer 
	public class TankUSSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankUSSpeedUnit _speedUnit	
			[SerializeField] private TankUSSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankUS_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankUS_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankUS_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankUS_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankUS_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankUS_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankUSSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankUSSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals TankUSSpeedUnit.mph
			if (_speedUnit == TankUSSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankUSSpeedUnit.mph
