/*
 * File: Humvee Controller
 * Name: HumveeController.cs
...
namespace VehiclesControl
{
	// public enum HumveeSpeedType
	public enum HumveeSpeedType
	{
		mph,
		kmh	

	} // close public enum HumveeSpeedType
	...
	public class HumveeController : MonoBehaviour
	{
		...
		[Header("Speed")]
			...
			// HumveeSpeedType _speedType	
			[SerializeField] private HumveeSpeedType _speedType;			
