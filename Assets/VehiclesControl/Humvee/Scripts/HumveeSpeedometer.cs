/*
 * File: Humvee Speedometer
 * Name: HumveeSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum HumveeSpeedUnit
	public enum HumveeSpeedUnit
	{
		mph,
		kmh	

	} // close public enum HumveeSpeedUnit

	// public class HumveeSpeedometer 
	public class HumveeSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// HumveeSpeedUnit _speedUnit	
			[SerializeField] private HumveeSpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName HumveeSpeedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("HumveeSpeedometer");
		...
		private void Update()
		{
			// if _speedUnit equals HumveeSpeedUnit.mph
			if (_speedUnit == HumveeSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals HumveeSpeedUnit.mph
	...
	} // close public class HumveeSpeedometer
