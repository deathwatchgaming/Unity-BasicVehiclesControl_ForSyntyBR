/*
 * File: Sedan Speedometer
 * Name: SedanSpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SedanSpeedUnit
	public enum SedanSpeedUnit
	{
		mph,
		kmh	

	} // close public enum SedanSpeedUnit

	// public class SedanSpeedometer 
	public class SedanSpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SedanSpeedUnit _speedUnit	
			[SerializeField] private SedanSpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SedanSpeedUnit.mph
			if (_speedUnit == SedanSpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SedanSpeedUnit.mph
	...
	} // close public class SedanSpeedometer
