...
namespace VehiclesControl
{
    ...
    {   
        ...
        private void Start() 
        {
            ...
            _interfaceTextObject = GameObject.Find("Sedan_EntryKey");
        ...
        private void Update()
        {
            // if _inSedan and Input GetKey KeyCode F
            ...
            } // close if _inSedan and Input GetKey KeyCode F
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            // if not _inSedan and gameObject tag is Player and Input GetKey KeyCode E
            ...
            } // close if not _inSedan and gameObject tag is Player and Input GetKey KeyCode E
