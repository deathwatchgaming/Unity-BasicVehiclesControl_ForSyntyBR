/*
 * File: TankUS 03 Camera
 * Name: TankUS03Camera.cs
...
namespace VehiclesControl
{
	// public class TankUS03Camera
	public class TankUS03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The TankUS 03 transform")]
			// Transform _tankUS03
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _tankUS03.position.y plus _height
			float _desiredHeight = _tankUS03.position.y + _height;
			...
			// transform position is _tankUS03.position
			transform.position = _tankUS03.position;
		...
		private void FixedUpdate()
		{
			// Vector3 _localVelocity is _tankUS03 InverseTransformDirection _tankUS03 GetComponent Rigidbody velocity
			Vector3 _localVelocity = _tankUS03.InverseTransformDirection(_tankUS03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _tankUS03.eulerAngles.y plus 180
				_tempVector3.y = _tankUS03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is_tankUS03.eulerAngles.y
				_tempVector3.y = _tankUS03.eulerAngles.y;
			...
			// float autoCamControl is_tankUS03 GetComponent Rigidbody velocity magnitude
			float _autoCamControl = _tankUS03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class TankUS03Camera
