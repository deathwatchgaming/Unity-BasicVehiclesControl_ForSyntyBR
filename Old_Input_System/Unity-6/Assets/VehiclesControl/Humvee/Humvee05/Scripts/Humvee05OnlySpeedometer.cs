/*
 * File: Humvee 05 Only Speedometer
 * Name: Humvee05OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee05OnlySpeedUnit
	public enum Humvee05OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee05OnlySpeedUnit

	// public class Humvee05OnlySpeedometer 
	public class Humvee05OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee05OnlySpeedUnit _speedUnit	
			[SerializeField] private Humvee05OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Humvee05OnlySpeedUnit.mph
			if (_speedUnit == Humvee05OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee05OnlySpeedUnit.mph
	...
	} // close public class Humvee05OnlySpeedometer
