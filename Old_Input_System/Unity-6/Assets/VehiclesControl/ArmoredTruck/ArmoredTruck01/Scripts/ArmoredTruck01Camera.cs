/*
 * File: Armored Truck 01 Camera
 * Name: ArmoredTruck01Camera.cs
...
namespace VehiclesControl
{
	...
	public class ArmoredTruck01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The armored truck 01 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _armoredTruck01.position.y plus _height
			float _desiredHeight = _armoredTruck01.position.y + _height;
			...
			// transform position is _armoredTruck01.position
			transform.position = _armoredTruck01.position;
			...
			// transform LookAt _armoredTruck01
			transform.LookAt(_armoredTruck01);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck01.InverseTransformDirection(_armoredTruck01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _armoredTruck01.eulerAngles.y plus 180
				_tempVector3.y = _armoredTruck01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _armoredTruck01.eulerAngles.y
				_tempVector3.y = _armoredTruck01.eulerAngles.y;
			...
			float _autoCamControl = _armoredTruck01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class ArmoredTruck01Camera
