/*
 * File: Armored Truck 02 Camera
 * Name: ArmoredTruck02Camera.cs
...
namespace VehiclesControl
{
	...
	public class ArmoredTruck02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The armored truck 02 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _armoredTruck02.position.y plus _height
			float _desiredHeight = _armoredTruck02.position.y + _height;
			...
			// transform position is _armoredTruck02.position
			transform.position = _armoredTruck02.position;
			...
			// transform LookAt _armoredTruck02
			transform.LookAt(_armoredTruck02);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck02.InverseTransformDirection(_armoredTruck02.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _armoredTruck02.eulerAngles.y plus 180
				_tempVector3.y = _armoredTruck02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _armoredTruck02.eulerAngles.y
				_tempVector3.y = _armoredTruck02.eulerAngles.y;
			...
			float _autoCamControl = _armoredTruck02.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class ArmoredTruck02Camera
