/*
 * File: Dune Buggy 03 Only Speedometer
 * Name: DuneBuggy03OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy03OnlySpeedUnit
	public enum DuneBuggy03OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy03OnlySpeedUnit

	// public class DuneBuggy03OnlySpeedometer 
	public class DuneBuggy03OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy03OnlySpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy03OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals DuneBuggy03OnlySpeedUnit.mph
			if (_speedUnit == DuneBuggy03OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy03OnlySpeedUnit.mph
	...
	} // close public class DuneBuggy03OnlySpeedometer
