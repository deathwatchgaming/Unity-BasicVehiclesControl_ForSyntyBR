/*
 * File: Dune Buggy 02 Only Speedometer
 * Name: DuneBuggy02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy02OnlySpeedUnit
	public enum DuneBuggy02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy02OnlySpeedUnit

	// public class DuneBuggy02OnlySpeedometer 
	public class DuneBuggy02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy02OnlySpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals DuneBuggy02OnlySpeedUnit.mph
			if (_speedUnit == DuneBuggy02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy02OnlySpeedUnit.mph
	...
	} // close public class DuneBuggy02OnlySpeedometer
