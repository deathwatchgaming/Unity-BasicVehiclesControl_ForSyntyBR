/*
*  Name: Dune Buggy 04 Compass
*  File: DuneBuggy04Compass.cs
...
namespace NavigationControl
{
	// public class DuneBuggy04Compass
	public class DuneBuggy04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The DuneBuggy04 transform")]
			// Transform _duneBuggy04
			[SerializeField] private Transform _duneBuggy04;
		...
		public static DuneBuggy04Compass _duneBuggy04Compass;

		// private void Start
		private void Start()
		{
			// _duneBuggy04Compass
			_duneBuggy04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component DuneBuggy04Compass is enabled
				GetComponent<DuneBuggy04Compass>().enabled = true;

				// Debug Log DuneBuggy04 compass is enabled
			...
			{
				// Debug Log DuneBuggy04 compass is disabled
				...
				// Get Component DuneBuggy04Compass is not enabled
				GetComponent<DuneBuggy04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _duneBuggy04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_duneBuggy04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _duneBuggy04 forward vector

			// Vector3 forward is _duneBuggy04 transform forward
			Vector3 forward = _duneBuggy04.transform.forward;

			// Zero out the Y of _duneBuggy04 forward vector to only get the direction in the X,Z 
	...
	} // close public class DuneBuggy04Compass
