/*
*  Name: Six Wheel Truck 06 Compass
*  File: SixWheelTruck06Compass.cs
...
namespace NavigationControl
{
	// public class SixWheelTruck06Compass
	public class SixWheelTruck06Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SixWheelTruck06 transform")]
			// Transform _sixWheelTruck06
			[SerializeField] private Transform _sixWheelTruck06;
		...
		public static SixWheelTruck06Compass _sixWheelTruck06Compass;

		// private void Start
		private void Start()
		{
			// _sixWheelTruck06Compass
			_sixWheelTruck06Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SixWheelTruck06Compass is enabled
				GetComponent<SixWheelTruck06Compass>().enabled = true;

				// Debug Log SixWheelTruck06 compass is enabled
			...
			{
				// Debug Log SixWheelTruck06 compass is disabled
				...
				// Get Component SixWheelTruck06Compass is not enabled
				GetComponent<SixWheelTruck06Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sixWheelTruck06 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sixWheelTruck06.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sixWheelTruck06 forward vector

			// Vector3 forward is _sixWheelTruck06 transform forward
			Vector3 forward = _sixWheelTruck06.transform.forward;

			// Zero out the Y of _sixWheelTruck06 forward vector to only get the direction in the X,Z 
	...
	} // close public class SixWheelTruck06Compass
