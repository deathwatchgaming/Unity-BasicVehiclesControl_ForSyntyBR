/*
*  Name: Six Wheel Truck 05 Compass
*  File: SixWheelTruck05Compass.cs
...
namespace NavigationControl
{
	// public class SixWheelTruck05Compass
	public class SixWheelTruck05Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SixWheelTruck05 transform")]
			// Transform _sixWheelTruck05
			[SerializeField] private Transform _sixWheelTruck05;
		...
		public static SixWheelTruck05Compass _sixWheelTruck05Compass;

		// private void Start
		private void Start()
		{
			// _sixWheelTruck05Compass
			_sixWheelTruck05Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SixWheelTruck05Compass is enabled
				GetComponent<SixWheelTruck05Compass>().enabled = true;

				// Debug Log SixWheelTruck05 compass is enabled
			...
			{
				// Debug Log SixWheelTruck05 compass is disabled
				...
				// Get Component SixWheelTruck05Compass is not enabled
				GetComponent<SixWheelTruck05Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sixWheelTruck05 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sixWheelTruck05.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sixWheelTruck05 forward vector

			// Vector3 forward is _sixWheelTruck05 transform forward
			Vector3 forward = _sixWheelTruck05.transform.forward;

			// Zero out the Y of _sixWheelTruck05 forward vector to only get the direction in the X,Z 
	...
	} // close public class SixWheelTruck05Compass
