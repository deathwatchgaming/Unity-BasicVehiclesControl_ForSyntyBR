/*
 * File: TankRU 06 Only Speedometer
 * Name: TankRU06OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU06OnlySpeedUnit
	public enum TankRU06OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU06OnlySpeedUnit

	// public class TankRU06OnlySpeedometer 
	public class TankRU06OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU06OnlySpeedUnit _speedUnit	
			[SerializeField] private TankRU06OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankRU06OnlySpeedUnit.mph
			if (_speedUnit == TankRU06OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU06OnlySpeedUnit.mph
	...
	} // close public class TankRU06OnlySpeedometer
