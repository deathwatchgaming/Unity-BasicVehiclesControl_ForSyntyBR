...
namespace VehiclesControl
{
	...
	public class ArmoredTruck06Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck06.InverseTransformDirection(_armoredTruck06.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _armoredTruck06.GetComponent<Rigidbody>().velocity.magnitude;
