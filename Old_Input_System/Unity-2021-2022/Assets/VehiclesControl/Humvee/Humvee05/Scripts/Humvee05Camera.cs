...
namespace VehiclesControl
{
	...
	public class Humvee05Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee05.InverseTransformDirection(_humvee05.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _humvee05.GetComponent<Rigidbody>().velocity.magnitude;
