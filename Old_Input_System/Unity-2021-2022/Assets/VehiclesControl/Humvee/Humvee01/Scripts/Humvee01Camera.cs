...
namespace VehiclesControl
{
	...
	public class Humvee01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee01.InverseTransformDirection(_humvee01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _humvee01.GetComponent<Rigidbody>().velocity.magnitude;
