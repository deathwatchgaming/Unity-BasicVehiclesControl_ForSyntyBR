/*
 * File: Humvee 02 Only Speedometer
 * Name: Humvee02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee02OnlySpeedUnit
	public enum Humvee02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee02OnlySpeedUnit

	// public class Humvee02OnlySpeedometer 
	public class Humvee02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee02OnlySpeedUnit _speedUnit	
			[SerializeField] private Humvee02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Humvee02OnlySpeedUnit.mph
			if (_speedUnit == Humvee02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee02OnlySpeedUnit.mph
	...
	} // close public class Humvee02OnlySpeedometer
