/*
 * File: Sedan 01 Only Speedometer
 * Name: Sedan01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan01OnlySpeedUnit
	public enum Sedan01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan01OnlySpeedUnit

	// public class Sedan01OnlySpeedometer 
	public class Sedan01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan01OnlySpeedUnit _speedUnit	
			[SerializeField] private Sedan01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Sedan01OnlySpeedUnit.mph
			if (_speedUnit == Sedan01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan01OnlySpeedUnit.mph
	...
	} // close public class Sedan01OnlySpeedometer
