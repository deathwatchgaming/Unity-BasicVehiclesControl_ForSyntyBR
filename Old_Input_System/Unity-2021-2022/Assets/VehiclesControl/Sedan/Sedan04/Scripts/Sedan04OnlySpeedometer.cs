/*
 * File: Sedan 04 Only Speedometer
 * Name: Sedan04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan04OnlySpeedUnit
	public enum Sedan04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan04OnlySpeedUnit

	// public class Sedan04OnlySpeedometer 
	public class Sedan04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan04OnlySpeedUnit _speedUnit	
			[SerializeField] private Sedan04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Sedan04OnlySpeedUnit.mph
			if (_speedUnit == Sedan04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan04OnlySpeedUnit.mph
	...
	} // close public class Sedan04OnlySpeedometer
