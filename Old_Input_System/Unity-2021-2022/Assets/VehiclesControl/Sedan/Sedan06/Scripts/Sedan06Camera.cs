...
namespace VehiclesControl
{
	...
	public class Sedan06Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan06.InverseTransformDirection(_sedan06.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _sedan06.GetComponent<Rigidbody>().velocity.magnitude;
