/*
*  Name: Tank US 05 Compass
*  File: TankUS05Compass.cs
...
namespace NavigationControl
{
	// public class TankUS05Compass
	public class TankUS05Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankUS05 transform")]
			// Transform _tankUS05
		...
		public static TankUS05Compass _tankUS05Compass;

		// private void Start
		private void Start()
		{
			// _tankUS05Compass
			_tankUS05Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankUS05Compass is enabled
				GetComponent<TankUS05Compass>().enabled = true;

				// Debug Log TankUS05 compass is enabled
			...
			{
				// Debug Log TankUS05 compass is disabled
				...
				// Get Component TankUS05Compass is not enabled
				GetComponent<TankUS05Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankUS05 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankUS05.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankUS05 forward vector

			// Vector3 forward is _tankUS05 transform forward
			Vector3 forward = _tankUS05.transform.forward;

			// Zero out the Y of _tankUS05 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankUS05Compass
