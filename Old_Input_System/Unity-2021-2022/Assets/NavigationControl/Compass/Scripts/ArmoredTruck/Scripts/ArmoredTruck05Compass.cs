/*
*  Name: Armored Truck 05 Compass
*  File: ArmoredTruck05Compass.cs
...
namespace NavigationControl
{
	// public class ArmoredTruck05Compass
	public class ArmoredTruck05Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The ArmoredTruck05 transform")]
			// Transform _armoredTruck05
			[SerializeField] private Transform _armoredTruck05;
		...
		public static ArmoredTruck05Compass _armoredTruck05Compass;

		// private void Start
		private void Start()
		{
			// _armoredTruck05Compass
			_armoredTruck05Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component ArmoredTruck05Compass is enabled
				GetComponent<ArmoredTruck05Compass>().enabled = true;

				// Debug Log ArmoredTruck05 compass is enabled
			...
			{
				// Debug Log ArmoredTruck05 compass is disabled
				...
				// Get Component ArmoredTruck05Compass is not enabled
				GetComponent<ArmoredTruck05Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _armoredTruck05 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_armoredTruck05.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _armoredTruck05 forward vector

			// Vector3 forward is _armoredTruck05 transform forward
			Vector3 forward = _armoredTruck05.transform.forward;

			// Zero out the Y of _armoredTruck05 forward vector to only get the direction in the X,Z 
	...
	} // close public class ArmoredTruck05Compass
