/*
*  Name: Armored Truck 01 Compass
*  File: ArmoredTruck01Compass.cs
...
namespace NavigationControl
{
	// public class ArmoredTruck01Compass
	public class ArmoredTruck01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The ArmoredTruck01 transform")]
			// Transform _armoredTruck01
			[SerializeField] private Transform _armoredTruck01;
		...
		public static ArmoredTruck01Compass _armoredTruck01Compass;

		// private void Start
		private void Start()
		{
			// _armoredTruck01Compass
			_armoredTruck01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component ArmoredTruck01Compass is enabled
				GetComponent<ArmoredTruck01Compass>().enabled = true;

				// Debug Log ArmoredTruck01 compass is enabled
			...
			{
				// Debug Log ArmoredTruck01 compass is disabled
				...
				// Get Component ArmoredTruck01Compass is not enabled
				GetComponent<ArmoredTruck01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _armoredTruck01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_armoredTruck01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _armoredTruck01 forward vector

			// Vector3 forward is _armoredTruck01 transform forward
			Vector3 forward = _armoredTruck01.transform.forward;

			// Zero out the Y of _armoredTruck01 forward vector to only get the direction in the X,Z 
	...
	} // close public class ArmoredTruck01Compass
