/*
*  Name: Six Wheel Truck 01 Compass
*  File: SixWheelTruck01Compass.cs
...
namespace NavigationControl
{
	// public class SixWheelTruck01Compass
	public class SixWheelTruck01Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SixWheelTruck01 transform")]
		...
		public static SixWheelTruck01Compass _sixWheelTruck01Compass;

		// private void Start
		private void Start()
		{
			// _sixWheelTruck01Compass
			_sixWheelTruck01Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SixWheelTruck01Compass is enabled
				GetComponent<SixWheelTruck01Compass>().enabled = true;

				// Debug Log SixWheelTruck01 compass is enabled
			...
			{
				// Debug Log SixWheelTruck01 compass is disabled
				...
				// Get Component SixWheelTruck01Compass is not enabled
				GetComponent<SixWheelTruck01Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sixWheelTruck01 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sixWheelTruck01.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sixWheelTruck01 forward vector

			// Vector3 forward is _sixWheelTruck01 transform forward
			Vector3 forward = _sixWheelTruck01.transform.forward;

			// Zero out the Y of _sixWheelTruck01 forward vector to only get the direction in the X,Z 
	...
	} // close public class SixWheelTruck01Compass
