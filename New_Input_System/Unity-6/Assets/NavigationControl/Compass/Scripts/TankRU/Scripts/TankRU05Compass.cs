/*
*  Name: Tank RU 05 Compass
*  File: TankRU05Compass.cs
...
namespace NavigationControl
{
	// public class TankRU05Compass
	public class TankRU05Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankRU05 transform")]
			// Transform _tankRU05
			[SerializeField] private Transform _tankRU05;
		...
		public static TankRU05Compass _tankRU05Compass;

		// private void Start
		private void Start()
		{
			// _tankRU05Compass
			_tankRU05Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankRU05Compass is enabled
				GetComponent<TankRU05Compass>().enabled = true;

				// Debug Log TankRU05 compass is enabled
			...
			{
				// Debug Log TankRU05 compass is disabled
				...
				// Get Component TankRU05Compass is not enabled
				GetComponent<TankRU05Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankRU05 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankRU05.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankRU05 forward vector

			// Vector3 forward is _tankRU05 transform forward
			Vector3 forward = _tankRU05.transform.forward;

			// Zero out the Y of _tankRU05 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankRU05Compass
