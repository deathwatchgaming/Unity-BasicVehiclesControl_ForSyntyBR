/*
*  Name: Armored Truck 02 Compass
*  File: ArmoredTruck02Compass.cs
...
namespace NavigationControl
{
	// public class ArmoredTruck02Compass
	public class ArmoredTruck02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The ArmoredTruck02 transform")]
			// Transform _armoredTruck02
			[SerializeField] private Transform _armoredTruck02;
		...
		public static ArmoredTruck02Compass _armoredTruck02Compass;

		// private void Start
		private void Start()
		{
			// _armoredTruck02Compass
			_armoredTruck02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component ArmoredTruck02Compass is enabled
				GetComponent<ArmoredTruck02Compass>().enabled = true;

				// Debug Log ArmoredTruck02 compass is enabled
			...
			{
				// Debug Log ArmoredTruck02 compass is disabled
				...
				// Get Component ArmoredTruck02Compass is not enabled
				GetComponent<ArmoredTruck02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _armoredTruck02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_armoredTruck02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _armoredTruck02 forward vector

			// Vector3 forward is _armoredTruck02 transform forward
			Vector3 forward = _armoredTruck02.transform.forward;

			// Zero out the Y of _armoredTruck02 forward vector to only get the direction in the X,Z 
	...
	} // close public class ArmoredTruck02Compass
