/*
 * File: Sedan 05 Controller (New Input System)
 * Name: Sedan05Controller.cs
...
namespace VehiclesControl
{
	// public enum Sedan05SpeedType
	public enum Sedan05SpeedType
	{
		mph,
		kmh	

	} // close public enum Sedan05SpeedType
	...
	// public class Sedan05Controller
	public class Sedan05Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// Sedan05SpeedType _speedType	
			[SerializeField] private Sedan05SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedan05 car from rolling
