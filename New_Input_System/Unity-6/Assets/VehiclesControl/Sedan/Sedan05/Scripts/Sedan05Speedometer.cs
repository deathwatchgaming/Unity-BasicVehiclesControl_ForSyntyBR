/*
 * File: Sedan 05 Speedometer (New Input System)
 * Name: Sedan05Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan05SpeedUnit
	public enum Sedan05SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan05SpeedUnit

	// public class Sedan05Speedometer 
	public class Sedan05Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan05SpeedUnit _speedUnit	
			[SerializeField] private Sedan05SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Sedan05_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Sedan05_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Sedan05_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Sedan05_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Sedan05_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Sedan05_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Sedan05Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Sedan05Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Sedan05SpeedUnit.mph
			if (_speedUnit == Sedan05SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan05SpeedUnit.mph
			...
			if (_inSedan05 && _exitButton == true)
			{
				// _inSedan05 is false
				_inSedan05 = false;
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedan05 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Sedan05Speedometer
