/*
 * File: Sedan 03 Controller (New Input System)
 * Name: Sedan03Controller.cs
...
namespace VehiclesControl
{
	// public enum Sedan03SpeedType
	public enum Sedan03SpeedType
	{
		mph,
		kmh	

	} // close public enum Sedan03SpeedType
	...
	// public class Sedan03Controller
	public class Sedan03Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// Sedan03SpeedType _speedType	
			[SerializeField] private Sedan03SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedan03 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Sedan03SpeedType.mph
			if (_speedType == Sedan03SpeedType.mph)
			{
			...
			} // close if _speedType equals Sedan03SpeedType.mph

			// else if _speedType equals Sedan03SpeedType.kmh
			else if (_speedType == Sedan03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Sedan03SpeedType.kmh
	...
	} // close public class Sedan03Controller
