/*
 * File: Sedan 04 Camera
 * Name: Sedan04Camera.cs
...
namespace VehiclesControl
{
	// public class Sedan04Camera
	public class Sedan04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The sedan 04 transform")]
			// Transform _sedan04
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedan04.position.y plus _height
			float _desiredHeight = _sedan04.position.y + _height;
			...
			// transform position is _sedan04.position
			transform.position = _sedan04.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan04.InverseTransformDirection(_sedan04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedan04.eulerAngles.y plus 180
				_tempVector3.y = _sedan04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedan04.eulerAngles.y
				_tempVector3.y = _sedan04.eulerAngles.y;
			...
			float _autoCamControl = _sedan04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Sedan04Camera
