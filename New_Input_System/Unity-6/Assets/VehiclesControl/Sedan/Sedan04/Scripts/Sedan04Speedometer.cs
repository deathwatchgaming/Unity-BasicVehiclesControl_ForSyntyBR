/*
 * File: Sedan 04 Speedometer (New Input System)
 * Name: Sedan04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan04SpeedUnit
	public enum Sedan04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan04SpeedUnit

	// public class Sedan04Speedometer 
	public class Sedan04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan04SpeedUnit _speedUnit	
			[SerializeField] private Sedan04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Sedan04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Sedan04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Sedan04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Sedan04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Sedan04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Sedan04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Sedan04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Sedan04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Sedan04SpeedUnit.mph
			if (_speedUnit == Sedan04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan04SpeedUnit.mph
			...
			if (_inSedan04 && _exitButton == true)
			{
				// _inSedan04 is false
				_inSedan04 = false;
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedan04 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Sedan04Speedometer
