/*
 * File: Sedan 02 Speedometer (New Input System)
 * Name: Sedan02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan02SpeedUnit
	public enum Sedan02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan02SpeedUnit

	// public class Sedan02Speedometer 
	public class Sedan02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan02SpeedUnit _speedUnit	
			[SerializeField] private Sedan02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Sedan02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Sedan02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Sedan02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Sedan02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Sedan02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Sedan02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Sedan02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Sedan02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Sedan02SpeedUnit.mph
			if (_speedUnit == Sedan02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan02SpeedUnit.mph
	...
	} // close public class Sedan02Speedometer
