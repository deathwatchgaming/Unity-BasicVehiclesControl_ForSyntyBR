/*
 * File: Six Wheel Truck 02 Speedometer (New Input System)
 * Name: SixWheelTruck02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SixWheelTruck02SpeedUnit
	public enum SixWheelTruck02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck02SpeedUnit

	// public class SixWheelTruck02Speedometer 
	public class SixWheelTruck02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck02SpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SixWheelTruck02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SixWheelTruck02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SixWheelTruck02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SixWheelTruck02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SixWheelTruck02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SixWheelTruck02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SixWheelTruck02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SixWheelTruck02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SixWheelTruck02SpeedUnit.mph
			if (_speedUnit == SixWheelTruck02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck02SpeedUnit.mph
			...
			if (_inSixWheelTruck02 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSixWheelTruck02 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SixWheelTruck02Speedometer
