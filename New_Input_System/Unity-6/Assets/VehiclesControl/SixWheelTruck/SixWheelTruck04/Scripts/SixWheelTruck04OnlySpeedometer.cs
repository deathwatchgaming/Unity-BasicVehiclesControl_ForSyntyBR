/*
 * File: Six Wheel Truck 04 Only Speedometer
 * Name: SixWheelTruck04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SixWheelTruck04OnlySpeedUnit
	public enum SixWheelTruck04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck04OnlySpeedUnit

	// public class SixWheelTruck04OnlySpeedometer 
	public class SixWheelTruck04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck04OnlySpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SixWheelTruck04OnlySpeedUnit.mph
			if (_speedUnit == SixWheelTruck04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck04OnlySpeedUnit.mph
	...
	} // close public class SixWheelTruck04OnlySpeedometer
