/*
 * File: Six Wheel Truck 05 Controller (New Input System)
 * Name: SixWheelTruck05Controller.cs
...
namespace VehiclesControl
{
	// public enum SixWheelTruck05SpeedType
	public enum SixWheelTruck05SpeedType
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck05SpeedType
	...
	// public class SixWheelTruck05Controller
	public class SixWheelTruck05Controller : MonoBehaviour
	{					    		
		// Require Components
		...
		[Header("Speed")]
			...
			// SixWheelTruck05SpeedType _speedType	
			[SerializeField] private SixWheelTruck05SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SixWheelTruck05SpeedType.mph
			if (_speedType == SixWheelTruck05SpeedType.mph)
			{
			...
			} // close if _speedType equals SixWheelTruck05SpeedType.mph

			// else if _speedType equals SixWheelTruck05SpeedType.kmh
			else if (_speedType == SixWheelTruck05SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SixWheelTruck05SpeedType.kmh
	...
	} // close public class SixWheelTruck05Controller
