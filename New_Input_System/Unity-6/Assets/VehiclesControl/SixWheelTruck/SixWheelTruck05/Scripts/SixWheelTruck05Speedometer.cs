/*
 * File: Six Wheel Truck 05 Speedometer (New Input System)
 * Name: SixWheelTruck05Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SixWheelTruck05SpeedUnit
	public enum SixWheelTruck05SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck05SpeedUnit

	// public class SixWheelTruck05Speedometer 
	public class SixWheelTruck05Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck05SpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck05SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SixWheelTruck05_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SixWheelTruck05_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SixWheelTruck05_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SixWheelTruck05_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SixWheelTruck05_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SixWheelTruck05_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SixWheelTruck05Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SixWheelTruck05Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SixWheelTruck05SpeedUnit.mph
			if (_speedUnit == SixWheelTruck05SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck05SpeedUnit.mph
			...
			if (_inSixWheelTruck05 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSixWheelTruck05 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SixWheelTruck05Speedometer
