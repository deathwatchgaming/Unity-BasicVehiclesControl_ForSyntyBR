/*
 * File: Six Wheel Truck 06 Only Speedometer
 * Name: SixWheelTruck06OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum SixWheelTruck06OnlySpeedUnit
	public enum SixWheelTruck06OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck06OnlySpeedUnit

	// public class SixWheelTruck06OnlySpeedometer 
	public class SixWheelTruck06OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck06OnlySpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck06OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals SixWheelTruck06OnlySpeedUnit.mph
			if (_speedUnit == SixWheelTruck06OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck06OnlySpeedUnit.mph
	...
	} // close public class SixWheelTruck06OnlySpeedometer
