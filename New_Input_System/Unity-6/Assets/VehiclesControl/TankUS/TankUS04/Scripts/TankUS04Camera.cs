/*
 * File: TankUS 04 Camera
 * Name: TankUS04Camera.cs
...
namespace VehiclesControl
{
	// public class TankUS04Camera
	public class TankUS04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The TankUS 04 transform")]
			// Transform _tankUS04
			[SerializeField] private Transform _tankUS04;
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _tankUS04.position.y plus _height
			float _desiredHeight = _tankUS04.position.y + _height;
			...
			// transform position is _tankUS04.position
			transform.position = _tankUS04.position;
		...
		private void FixedUpdate()
		{
			// Vector3 _localVelocity is _tankUS04 InverseTransformDirection _tankUS04 GetComponent Rigidbody velocity
			Vector3 _localVelocity = _tankUS04.InverseTransformDirection(_tankUS04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _tankUS04.eulerAngles.y plus 180
				_tempVector3.y = _tankUS04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is_tankUS04.eulerAngles.y
				_tempVector3.y = _tankUS04.eulerAngles.y;
			...
			// float autoCamControl is_tankUS04 GetComponent Rigidbody velocity magnitude
			float _autoCamControl = _tankUS04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class TankUS04Camera
