/*
 * File: TankUS 01 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankUS01Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankUS01BodyRotation.y += _moveInput.x * _tankUS01RotationSpeed;
			...
			_tankUS01TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
