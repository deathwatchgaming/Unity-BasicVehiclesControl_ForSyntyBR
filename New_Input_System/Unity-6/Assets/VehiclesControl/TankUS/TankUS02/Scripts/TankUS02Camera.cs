/*
 * File: TankUS 02 Camera
 * Name: TankUS02Camera.cs
...
namespace VehiclesControl
{
	// public class TankUS02Camera
	public class TankUS02Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The tankUS02 transform")]
			// Transform _tankUS02
			[SerializeField] private Transform _tankUS02;
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _tankUS02.position.y plus _height
			float _desiredHeight = _tankUS02.position.y + _height;
			...
			// transform position is _tankUS02.position
			transform.position = _tankUS02.position;
		...
		private void FixedUpdate()
		{
			// Vector3 _localVelocity is _tankUS02 InverseTransformDirection _tankUS02 GetComponent Rigidbody velocity
			Vector3 _localVelocity = _tankUS02.InverseTransformDirection(_tankUS02.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _tankUS02.eulerAngles.y plus 180
				_tempVector3.y = _tankUS02.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is_tankUS02.eulerAngles.y
				_tempVector3.y = _tankUS02.eulerAngles.y;
			...
			// float autoCamControl is_tankUS02 GetComponent Rigidbody velocity magnitude
			float _autoCamControl = _tankUS02.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class TankUS02Camera
