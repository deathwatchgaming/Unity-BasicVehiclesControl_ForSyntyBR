/*
 * File: TankUS 02 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankUS02Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankUS02BodyRotation.y += _moveInput.x * _tankUS02RotationSpeed;
			...
			_tankUS02TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
