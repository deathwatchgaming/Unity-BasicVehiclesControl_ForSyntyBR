/*
 * File: TankUS 02 Only Speedometer
 * Name: TankUS02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankUS02OnlySpeedUnit
	public enum TankUS02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankUS02OnlySpeedUnit

	// public class TankUS02OnlySpeedometer 
	public class TankUS02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankUS02OnlySpeedUnit _speedUnit	
			[SerializeField] private TankUS02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankUS02OnlySpeedUnit.mph
			if (_speedUnit == TankUS02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankUS02OnlySpeedUnit.mph
	...
	} // close public class TankUS02OnlySpeedometer
