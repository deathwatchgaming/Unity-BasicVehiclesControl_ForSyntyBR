/*
 * File: TankUS 05 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankUS05Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankUS05BodyRotation.y += _moveInput.x * _tankUS05RotationSpeed;
			...
			_tankUS05TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
