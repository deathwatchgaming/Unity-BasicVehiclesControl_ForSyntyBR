/*
 * File: TankUS 05 Speedometer (New Input System)
 * Name: TankUS05Speedometer.cs
...
namespace VehiclesControl
{
    // public enum TankUS05SpeedUnit
	public enum TankUS05SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankUS05SpeedUnit

	// public class TankUS05Speedometer 
	public class TankUS05Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankUS05SpeedUnit _speedUnit	
			[SerializeField] private TankUS05SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankUS05_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankUS05_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankUS05_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankUS05_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankUS05_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankUS05_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankUS05Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankUS05Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals TankUS05SpeedUnit.mph
			if (_speedUnit == TankUS05SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankUS05SpeedUnit.mph
	...
	} // close public class TankUS05Speedometer
