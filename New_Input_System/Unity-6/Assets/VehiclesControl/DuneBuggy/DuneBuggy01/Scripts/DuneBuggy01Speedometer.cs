/*
 * File: Dune Buggy 01 Speedometer (New Input System)
 * Name: DuneBuggy01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy01SpeedUnit
	public enum DuneBuggy01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy01SpeedUnit

	// public class DuneBuggy01Speedometer 
	public class DuneBuggy01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy01SpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName DuneBuggy01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("DuneBuggy01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName DuneBuggy01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("DuneBuggy01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName DuneBuggy01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("DuneBuggy01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName DuneBuggy01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("DuneBuggy01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals DuneBuggy01SpeedUnit.mph
			if (_speedUnit == DuneBuggy01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy01SpeedUnit.mph
			...
			if (_inDuneBuggy01 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inDuneBuggy01 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class DuneBuggy01Speedometer
