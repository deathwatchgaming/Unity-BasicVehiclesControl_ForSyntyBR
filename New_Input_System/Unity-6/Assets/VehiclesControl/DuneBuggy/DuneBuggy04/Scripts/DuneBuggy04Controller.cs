/*
 * File: Dune Buggy 04 Controller (New Input System)
 * Name: DuneBuggy04Controller.cs
...
namespace VehiclesControl
{
	// public enum DuneBuggy04SpeedType
	public enum DuneBuggy04SpeedType
	{
		mph,
		kmh	

	} // close public enum DuneBuggy04SpeedType
	...
	// public class DuneBuggy04Controller
	public class DuneBuggy04Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// DuneBuggy04SpeedType _speedType	
			[SerializeField] private DuneBuggy04SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals DuneBuggy04SpeedType.mph
			if (_speedType == DuneBuggy04SpeedType.mph)
			{
			...
			} // close if _speedType equals DuneBuggy04SpeedType.mph

			// else if _speedType equals DuneBuggy04SpeedType.kmh
			else if (_speedType == DuneBuggy04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals DuneBuggy04SpeedType.kmh
	...
	} // close public class DuneBuggy04Controller
