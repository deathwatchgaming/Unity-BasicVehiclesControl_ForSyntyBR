/*
 * File: Dune Buggy 06 Speedometer (New Input System)
 * Name: DuneBuggy06Speedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy06SpeedUnit
	public enum DuneBuggy06SpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy06SpeedUnit

	// public class DuneBuggy06Speedometer 
	public class DuneBuggy06Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy06SpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy06SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName DuneBuggy06_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("DuneBuggy06_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName DuneBuggy06_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("DuneBuggy06_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName DuneBuggy06_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("DuneBuggy06_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName DuneBuggy06Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("DuneBuggy06Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals DuneBuggy06SpeedUnit.mph
			if (_speedUnit == DuneBuggy06SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy06SpeedUnit.mph
			...
			if (_inDuneBuggy06 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inDuneBuggy06 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class DuneBuggy06Speedometer
