/*
 * File: Dune Buggy 05 Speedometer (New Input System)
 * Name: DuneBuggy05Speedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy05SpeedUnit
	public enum DuneBuggy05SpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy05SpeedUnit

	// public class DuneBuggy05Speedometer 
	public class DuneBuggy05Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy05SpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy05SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName DuneBuggy05_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("DuneBuggy05_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName DuneBuggy05_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("DuneBuggy05_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName DuneBuggy05_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("DuneBuggy05_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName DuneBuggy05Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("DuneBuggy05Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals DuneBuggy05SpeedUnit.mph
			if (_speedUnit == DuneBuggy05SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy05SpeedUnit.mph
	...
	} // close public class DuneBuggy05Speedometer
