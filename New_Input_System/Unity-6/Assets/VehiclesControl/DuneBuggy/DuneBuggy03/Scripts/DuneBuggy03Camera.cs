...
namespace VehiclesControl
{
	...
	public class DuneBuggy03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _duneBuggy03.InverseTransformDirection(_duneBuggy03.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _duneBuggy03.GetComponent<Rigidbody>().linearVelocity.magnitude;
