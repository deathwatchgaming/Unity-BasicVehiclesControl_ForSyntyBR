/*
 * File: Dune Buggy 02 Controller (New Input System)
 * Name: DuneBuggy02Controller.cs
...
namespace VehiclesControl
{
	// public enum DuneBuggy02SpeedType
	public enum DuneBuggy02SpeedType
	{
		mph,
		kmh	

	} // close public enum DuneBuggy02SpeedType
	...
	// public class DuneBuggy02Controller
	public class DuneBuggy02Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// DuneBuggy02SpeedType _speedType	
			[SerializeField] private DuneBuggy02SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals DuneBuggy02SpeedType.mph
			if (_speedType == DuneBuggy02SpeedType.mph)
			{
			...
			} // close if _speedType equals DuneBuggy02SpeedType.mph

			// else if _speedType equals DuneBuggy02SpeedType.kmh
			else if (_speedType == DuneBuggy02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals DuneBuggy02SpeedType.kmh
	...
	} // close public class DuneBuggy02Controller
