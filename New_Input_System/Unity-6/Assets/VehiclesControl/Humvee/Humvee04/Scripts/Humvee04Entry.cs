/*
 * File: Humvee 04 Entry (New Input System)
...
namespace VehiclesControl
{
    ...
    {  
        ...
        [Header("Compass")]
            ...
            [Tooltip("The humvee 04 compass")]
            // Humvee04Compass _humvee04Compass
            [SerializeField] private Humvee04Compass _humvee04Compass;
        ...
        //public static Humvee04Entry _humvee04Entry;
        ...
        private void Start() 
        {
            ...
            // _humvee04Compass enabled is false
            _humvee04Compass.enabled = false;

            // _humvee04Compass compassEnabled is false
            _humvee04Compass.compassEnabled = false;
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (!_inHumvee04 && other.gameObject.tag == "Player" && _enterButton == true)
            {
                ...
                // _humvee04Compass enabled is true
                _humvee04Compass.enabled = true;

                // _humvee04Compass compassEnabled is true
                _humvee04Compass.compassEnabled = true;
