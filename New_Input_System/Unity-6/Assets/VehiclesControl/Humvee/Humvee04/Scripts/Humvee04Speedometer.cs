/*
 * File: Humvee 04 Speedometer (New Input System)
 * Name: Humvee04Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee04SpeedUnit
	public enum Humvee04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee04SpeedUnit

	// public class Humvee04Speedometer 
	public class Humvee04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee04SpeedUnit _speedUnit	
			[SerializeField] private Humvee04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Humvee04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Humvee04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Humvee04SpeedUnit.mph
			if (_speedUnit == Humvee04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee04SpeedUnit.mph
			...
			if (_inHumvee04 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inHumvee04 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Humvee04Speedometer
