/*
 * File: Humvee 01 Speedometer (New Input System)
 * Name: Humvee01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee01SpeedUnit
	public enum Humvee01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee01SpeedUnit

	// public class Humvee01Speedometer 
	public class Humvee01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee01SpeedUnit _speedUnit	
			[SerializeField] private Humvee01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Humvee01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Humvee01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Humvee01SpeedUnit.mph
			if (_speedUnit == Humvee01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee01SpeedUnit.mph
			...
			if (_inHumvee01 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inHumvee01 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Humvee01Speedometer
