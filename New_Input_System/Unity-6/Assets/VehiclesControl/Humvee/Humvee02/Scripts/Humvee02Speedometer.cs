/*
 * File: Humvee 02 Speedometer (New Input System)
 * Name: Humvee02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee02SpeedUnit
	public enum Humvee02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee02SpeedUnit

	// public class Humvee02Speedometer 
	public class Humvee02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee02SpeedUnit _speedUnit	
			[SerializeField] private Humvee02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Humvee02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Humvee02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Humvee02SpeedUnit.mph
			if (_speedUnit == Humvee02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee02SpeedUnit.mph
	...
	} // close public class Humvee02Speedometer
