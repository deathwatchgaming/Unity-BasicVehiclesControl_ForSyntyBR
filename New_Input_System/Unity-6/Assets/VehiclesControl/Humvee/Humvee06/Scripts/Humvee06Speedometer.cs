/*
 * File: Humvee 06 Speedometer (New Input System)
 * Name: Humvee06Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee06SpeedUnit
	public enum Humvee06SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee06SpeedUnit

	// public class Humvee06Speedometer 
	public class Humvee06Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee06SpeedUnit _speedUnit	
			[SerializeField] private Humvee06SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee06_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee06_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee06_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee06_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee06_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee06_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Humvee06Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Humvee06Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Humvee06SpeedUnit.mph
			if (_speedUnit == Humvee06SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee06SpeedUnit.mph
			...
			if (_inHumvee06 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inHumvee06 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Humvee06Speedometer
