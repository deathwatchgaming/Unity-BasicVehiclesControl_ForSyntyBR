/*
 * File: Humvee 06 Only Speedometer
 * Name: Humvee06OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee06OnlySpeedUnit
	public enum Humvee06OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee06OnlySpeedUnit

	// public class Humvee06OnlySpeedometer 
	public class Humvee06OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee06OnlySpeedUnit _speedUnit	
			[SerializeField] private Humvee06OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Humvee06OnlySpeedUnit.mph
			if (_speedUnit == Humvee06OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee06OnlySpeedUnit.mph
	...
	} // close public class Humvee06OnlySpeedometer
