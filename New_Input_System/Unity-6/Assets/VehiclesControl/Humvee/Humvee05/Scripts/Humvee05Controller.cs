/*
 * File: Humvee 05 Controller (New Input System)
 * Name: Humvee05Controller.cs
...
namespace VehiclesControl
{
	// public enum Humvee05SpeedType
	public enum Humvee05SpeedType
	{
		mph,
		kmh	

	} // close public enum Humvee05SpeedType
	...
	// public class Humvee05Controller
	public class Humvee05Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Humvee05SpeedType _speedType	
			[SerializeField] private Humvee05SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Humvee05 from rolling
		...
		private void HandleSpeed()
		{
			...
			} // close if _speedType equals Humvee05SpeedType.mph

			// else if _speedType equals Humvee05SpeedType.kmh
			else if (_speedType == Humvee05SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Humvee05SpeedType.kmh
	...
	} // close public class Humvee05Controller
