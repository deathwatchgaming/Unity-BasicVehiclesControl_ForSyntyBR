/*
 * File: Humvee 05 Speedometer (New Input System)
 * Name: Humvee05Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee05SpeedUnit
	public enum Humvee05SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee05SpeedUnit

	// public class Humvee05Speedometer 
	public class Humvee05Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee05SpeedUnit _speedUnit	
			[SerializeField] private Humvee05SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee05_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee05_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee05_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee05_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee05_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee05_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Humvee05Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Humvee05Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Humvee05SpeedUnit.mph
			if (_speedUnit == Humvee05SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee05SpeedUnit.mph
	...
	} // close public class Humvee05Speedometer
