/*
 * File: Armored Truck 02 Speedometer (New Input System)
 * Name: ArmoredTruck02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck02SpeedUnit
	public enum ArmoredTruck02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck02SpeedUnit

	// public class ArmoredTruck02Speedometer 
	public class ArmoredTruck02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck02SpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName ArmoredTruck02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("ArmoredTruck02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName ArmoredTruck02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("ArmoredTruck02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName ArmoredTruck02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("ArmoredTruck02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName ArmoredTruck02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("ArmoredTruck02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals ArmoredTruck02SpeedUnit.mph
			if (_speedUnit == ArmoredTruck02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck02SpeedUnit.mph
			...
			if (_inArmoredTruck02 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inArmoredTruck02 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class ArmoredTruck02Speedometer
