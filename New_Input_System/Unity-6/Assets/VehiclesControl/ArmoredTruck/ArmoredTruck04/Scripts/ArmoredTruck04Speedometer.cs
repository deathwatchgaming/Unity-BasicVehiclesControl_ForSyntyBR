/*
 * File: Armored Truck 04 Speedometer (New Input System)
...
namespace VehiclesControl
{
    // public enum ArmoredTruck04SpeedUnit
	public enum ArmoredTruck04SpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck04SpeedUnit

	// public class ArmoredTruck04Speedometer 
	public class ArmoredTruck04Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck04SpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck04SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName ArmoredTruck04_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("ArmoredTruck04_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName ArmoredTruck04_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("ArmoredTruck04_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName ArmoredTruck04_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("ArmoredTruck04_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName ArmoredTruck04Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("ArmoredTruck04Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals ArmoredTruck04SpeedUnit.mph
			if (_speedUnit == ArmoredTruck04SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck04SpeedUnit.mph
	...
	} // close public class ArmoredTruck04Speedometer
