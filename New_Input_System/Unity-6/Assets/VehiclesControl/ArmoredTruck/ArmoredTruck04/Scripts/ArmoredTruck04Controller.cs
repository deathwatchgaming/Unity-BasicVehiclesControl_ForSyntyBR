/*
 * File: Armored Truck 04 Controller (New Input System)
 * Name: ArmoredTruck04Controller.cs
...
namespace VehiclesControl
{
	// public enum ArmoredTruck04SpeedType
	public enum ArmoredTruck04SpeedType
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck04SpeedType
	...
	// public class ArmoredTruck04Controller
	public class ArmoredTruck04Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// ArmoredTruck04SpeedType _speedType	
			[SerializeField] private ArmoredTruck04SpeedType _speedType;			
