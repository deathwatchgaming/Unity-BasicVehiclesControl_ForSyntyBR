/*
 * File: Armored Truck 03 Camera
 * Name: ArmoredTruck03Camera.cs
...
namespace VehiclesControl
{
	...
	public class ArmoredTruck03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The armored truck 03 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _armoredTruck03.position.y plus _height
			float _desiredHeight = _armoredTruck03.position.y + _height;
			...
			// transform position is _armoredTruck03.position
			transform.position = _armoredTruck03.position;
			...
			// transform LookAt _armoredTruck03
			transform.LookAt(_armoredTruck03);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck03.InverseTransformDirection(_armoredTruck03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _armoredTruck03.eulerAngles.y plus 180
				_tempVector3.y = _armoredTruck03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _armoredTruck03.eulerAngles.y
				_tempVector3.y = _armoredTruck03.eulerAngles.y;
			...
			float _autoCamControl = _armoredTruck03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class ArmoredTruck03Camera
