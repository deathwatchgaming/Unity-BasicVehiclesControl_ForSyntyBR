/*
 * File: Armored Truck 03 Speedometer (New Input System)
 * Name: ArmoredTruck03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck03SpeedUnit
	public enum ArmoredTruck03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck03SpeedUnit

	// public class ArmoredTruck03Speedometer 
	public class ArmoredTruck03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck03SpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName ArmoredTruck03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("ArmoredTruck03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName ArmoredTruck03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("ArmoredTruck03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName ArmoredTruck03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("ArmoredTruck03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName ArmoredTruck03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("ArmoredTruck03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals ArmoredTruck03SpeedUnit.mph
			if (_speedUnit == ArmoredTruck03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck03SpeedUnit.mph
			...
			if (_inArmoredTruck03 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inArmoredTruck03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class ArmoredTruck03Speedometer
