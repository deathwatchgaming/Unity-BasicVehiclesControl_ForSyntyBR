/*
 * File: Armored Truck 03 Controller (New Input System)
 * Name: ArmoredTruck03Controller.cs
...
namespace VehiclesControl
{
	// public enum ArmoredTruck03SpeedType
	public enum ArmoredTruck03SpeedType
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck03SpeedType
	...
	// public class ArmoredTruck03Controller
	public class ArmoredTruck03Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// ArmoredTruck03SpeedType _speedType	
			[SerializeField] private ArmoredTruck03SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals ArmoredTruck03SpeedType.mph
			if (_speedType == ArmoredTruck03SpeedType.mph)
			{
			...
			} // close if _speedType equals ArmoredTruck03SpeedType.mph

			// else if _speedType equals ArmoredTruck03SpeedType.kmh
			else if (_speedType == ArmoredTruck03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals ArmoredTruck03SpeedType.kmh
	...
	} // close public class ArmoredTruck03Controller
