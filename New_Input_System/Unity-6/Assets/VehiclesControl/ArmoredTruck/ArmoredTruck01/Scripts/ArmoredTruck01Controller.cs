/*
 * File: Armored Truck 01 Controller (New Input System)
 * Name: ArmoredTruck01Controller.cs
...
namespace VehiclesControl
{
	// public enum ArmoredTruck01SpeedType
	public enum ArmoredTruck01SpeedType
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck01SpeedType
	...
	// public class ArmoredTruck01Controller
	public class ArmoredTruck01Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// ArmoredTruck01SpeedType _speedType	
			[SerializeField] private ArmoredTruck01SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals ArmoredTruck01SpeedType.mph
			if (_speedType == ArmoredTruck01SpeedType.mph)
			{
			...
			} // close if _speedType equals ArmoredTruck01SpeedType.mph

			// else if _speedType equals ArmoredTruck01SpeedType.kmh
			else if (_speedType == ArmoredTruck01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals ArmoredTruck01SpeedType.kmh
	...
	} // close public class ArmoredTruck01Controller
