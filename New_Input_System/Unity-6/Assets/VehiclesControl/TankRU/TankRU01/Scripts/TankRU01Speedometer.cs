/*
 * File: Tank RU 01 Speedometer (New Input System)
 * Name: TankRU01Speedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU01SpeedUnit
	public enum TankRU01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU01SpeedUnit

	// public class TankRU01Speedometer 
	public class TankRU01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU01SpeedUnit _speedUnit	
			[SerializeField] private TankRU01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankRU01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankRU01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankRU01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankRU01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankRU01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankRU01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankRU01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankRU01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals TankRU01SpeedUnit.mph
			if (_speedUnit == TankRU01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU01SpeedUnit.mph
			...
			if (_inTankRU01 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inTankRU01 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class TankRU01Speedometer
