...
namespace VehiclesControl
{
	...
	public class TankRU02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			// float autoCamControl is_tankRU02 GetComponent Rigidbody velocity magnitude
			float _autoCamControl = _tankRU02.GetComponent<Rigidbody>().linearVelocity.magnitude;
