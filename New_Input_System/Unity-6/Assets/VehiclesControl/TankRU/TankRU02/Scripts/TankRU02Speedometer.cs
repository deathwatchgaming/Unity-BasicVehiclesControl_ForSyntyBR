/*
 * File: Tank RU 02 Speedometer (New Input System)
 * Name: TankRU02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU02SpeedUnit
	public enum TankRU02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU02SpeedUnit

	// public class TankRU02Speedometer 
	public class TankRU02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU02SpeedUnit _speedUnit	
			[SerializeField] private TankRU02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankRU02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankRU02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankRU02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankRU02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankRU02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankRU02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankRU02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankRU02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals TankRU02SpeedUnit.mph
			if (_speedUnit == TankRU02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU02SpeedUnit.mph
			...
			if (_inTankRU02 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inTankRU02 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class TankRU02Speedometer
