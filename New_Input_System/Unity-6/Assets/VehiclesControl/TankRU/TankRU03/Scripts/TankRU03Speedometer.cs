...
namespace VehiclesControl
{
    // public enum TankRU03SpeedUnit
	public enum TankRU03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU03SpeedUnit

	// public class TankRU03Speedometer 
	public class TankRU03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU03SpeedUnit _speedUnit	
			[SerializeField] private TankRU03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankRU03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankRU03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankRU03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankRU03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankRU03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankRU03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankRU03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankRU03Speedometer");
		...
		private void Update()
		{
			...
			} // close if _speedUnit equals TankRU03SpeedUnit.mph
	...
	} // close public class TankRU03Speedometer
