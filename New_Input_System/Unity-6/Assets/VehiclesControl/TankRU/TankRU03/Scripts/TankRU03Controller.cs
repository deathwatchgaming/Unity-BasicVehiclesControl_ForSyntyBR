/*
 * File: Tank RU 03 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankRU03Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankRU03BodyRotation.y += _moveInput.x * _tankRU03RotationSpeed;
			...
			_tankRU03TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
