/*
*  Name: Sedan 04 Compass
*  File: Sedan04Compass.cs
...
namespace NavigationControl
{
	// public class Sedan04Compass
	public class Sedan04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Sedan04 transform")]
			// Transform _sedan04
			[SerializeField] private Transform _sedan04;
		...
		// Sedan04Compass _sedan04Compass
		public static Sedan04Compass _sedan04Compass;

		// private void Start
		private void Start()
		{
			// _sedan04Compass
			_sedan04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Sedan04Compass is enabled
				GetComponent<Sedan04Compass>().enabled = true;

				// Debug Log Sedan04 compass is enabled
				//Debug.Log("The Sedan04 compass is enabled");
			...
			{
				// Debug Log Sedan04 compass is disabled
				//Debug.Log("The Sedan04 compass is disabled");
				...
				// Get Component Sedan04Compass is not enabled
				GetComponent<Sedan04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedan04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedan04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedan04 forward vector

			// Vector3 forward is _sedan04 transform forward
			Vector3 forward = _sedan04.transform.forward;

			// Zero out the Y of _sedan04 forward vector to only get the direction in the X,Z 
	...
	} // close public class Sedan04Compass
