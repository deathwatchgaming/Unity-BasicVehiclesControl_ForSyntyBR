/*
*  Name: Sedan 06 Compass
*  File: Sedan06Compass.cs
...
namespace NavigationControl
{
	// public class Sedan06Compass
	public class Sedan06Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Sedan06 transform")]
			// Transform _sedan06
			[SerializeField] private Transform _sedan06;
		...
		public static Sedan06Compass _sedan06Compass;

		// private void Start
		private void Start()
		{
			// _sedan06Compass
			_sedan06Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Sedan06Compass is enabled
				GetComponent<Sedan06Compass>().enabled = true;

				// Debug Log Sedan06 compass is enabled
			...
			{
				// Debug Log Sedan06 compass is disabled
				...
				// Get Component Sedan06Compass is not enabled
				GetComponent<Sedan06Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedan06 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedan06.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedan06 forward vector

			// Vector3 forward is _sedan06 transform forward
			Vector3 forward = _sedan06.transform.forward;

			// Zero out the Y of _sedan06 forward vector to only get the direction in the X,Z 
	...
	} // close public class Sedan06Compass
