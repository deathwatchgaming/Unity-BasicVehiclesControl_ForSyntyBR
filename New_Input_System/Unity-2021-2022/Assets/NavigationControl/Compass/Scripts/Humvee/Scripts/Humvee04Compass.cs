/*
*  Name: Humvee 04 Compass
*  File: Humvee04Compass.cs
...
namespace NavigationControl
{
	// public class Humvee04Compass
	public class Humvee04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Humvee04 transform")]
			// Transform _humvee04
			[SerializeField] private Transform _humvee04;
		...
		// Humvee04Compass _humvee04Compass
		public static Humvee04Compass _humvee04Compass;

		// private void Start
		private void Start()
		{
			// _humvee04Compass
			_humvee04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Humvee04Compass is enabled
				GetComponent<Humvee04Compass>().enabled = true;

				// Debug Log Humvee04 compass is enabled
				//Debug.Log("The Humvee04 compass is enabled");
			...
			{
				// Debug Log Humvee04 compass is disabled
				//Debug.Log("The Humvee04 compass is disabled");
				...
				// Get Component Humvee04Compass is not enabled
				GetComponent<Humvee04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _humvee04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_humvee04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _humvee04 forward vector

			// Vector3 forward is _humvee04 transform forward
			Vector3 forward = _humvee04.transform.forward;

			// Zero out the Y of _humvee04 forward vector to only get the direction in the X,Z 
	...
	} // close public class Humvee04Compass
