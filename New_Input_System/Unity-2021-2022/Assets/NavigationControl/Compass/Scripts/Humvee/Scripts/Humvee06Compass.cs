/*
*  Name: Humvee 06 Compass
*  File: Humvee06Compass.cs
...
namespace NavigationControl
{
	// public class Humvee06Compass
	public class Humvee06Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Humvee06 transform")]
			// Transform _humvee06
		...
		public static Humvee06Compass _humvee06Compass;

		// private void Start
		private void Start()
		{
			// _humvee06Compass
			_humvee06Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Humvee06Compass is enabled
				GetComponent<Humvee06Compass>().enabled = true;

				// Debug Log Humvee06 compass is enabled
			...
			{
				// Debug Log Humvee06 compass is disabled
				...
				// Get Component Humvee06Compass is not enabled
				GetComponent<Humvee06Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _humvee06 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_humvee06.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _humvee06 forward vector

			// Vector3 forward is _humvee06 transform forward
			Vector3 forward = _humvee06.transform.forward;

			// Zero out the Y of _humvee06 forward vector to only get the direction in the X,Z 
	...
	} // close public class Humvee06Compass
