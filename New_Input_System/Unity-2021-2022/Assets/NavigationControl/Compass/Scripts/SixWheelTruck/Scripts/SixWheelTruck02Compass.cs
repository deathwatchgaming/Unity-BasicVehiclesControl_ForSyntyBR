/*
*  Name: Six Wheel Truck 02 Compass
*  File: SixWheelTruck02Compass.cs
...
namespace NavigationControl
{
	// public class SixWheelTruck02Compass
	public class SixWheelTruck02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SixWheelTruck02 transform")]
		...
		// SixWheelTruck02Compass _sixWheelTruck02Compass
		public static SixWheelTruck02Compass _sixWheelTruck02Compass;

		// private void Start
		private void Start()
		{
			// _sixWheelTruck02Compass
			_sixWheelTruck02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SixWheelTruck02Compass is enabled
				GetComponent<SixWheelTruck02Compass>().enabled = true;

				// Debug Log SixWheelTruck02 compass is enabled
				//Debug.Log("The SixWheelTruck02 compass is enabled");
			...
			{
				// Debug Log SixWheelTruck02 compass is disabled
				//Debug.Log("The SixWheelTruck02 compass is disabled");
				...
				// Get Component SixWheelTruck02Compass is not enabled
				GetComponent<SixWheelTruck02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sixWheelTruck02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sixWheelTruck02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sixWheelTruck02 forward vector

			// Vector3 forward is _sixWheelTruck02 transform forward
			Vector3 forward = _sixWheelTruck02.transform.forward;

			// Zero out the Y of _sixWheelTruck02 forward vector to only get the direction in the X,Z 
	...
	} // close public class SixWheelTruck02Compass
