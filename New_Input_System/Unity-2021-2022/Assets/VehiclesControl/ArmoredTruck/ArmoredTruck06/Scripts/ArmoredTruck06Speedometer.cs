/*
 * File: Armored Truck 06 Speedometer (New Input System)
 * Name: ArmoredTruck06Speedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck06SpeedUnit
	public enum ArmoredTruck06SpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck06SpeedUnit

	// public class ArmoredTruck06Speedometer 
	public class ArmoredTruck06Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck06SpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck06SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName ArmoredTruck06_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("ArmoredTruck06_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName ArmoredTruck06_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("ArmoredTruck06_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName ArmoredTruck06_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("ArmoredTruck06_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName ArmoredTruck06Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("ArmoredTruck06Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals ArmoredTruck06SpeedUnit.mph
			if (_speedUnit == ArmoredTruck06SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck06SpeedUnit.mph
	...
	} // close public class ArmoredTruck06Speedometer
