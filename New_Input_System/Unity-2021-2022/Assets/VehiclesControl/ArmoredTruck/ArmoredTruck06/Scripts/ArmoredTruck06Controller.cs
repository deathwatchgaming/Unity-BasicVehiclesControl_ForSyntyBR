/*
 * File: Armored Truck 06 Controller (New Input System)
 * Name: ArmoredTruck06Controller.cs
...
namespace VehiclesControl
{
	// public enum ArmoredTruck06SpeedType
	public enum ArmoredTruck06SpeedType
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck06SpeedType
	...
	// public class ArmoredTruck06Controller
	public class ArmoredTruck06Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// ArmoredTruck06SpeedType _speedType	
			[SerializeField] private ArmoredTruck06SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals ArmoredTruck06SpeedType.mph
			if (_speedType == ArmoredTruck06SpeedType.mph)
			{
			...
			} // close if _speedType equals ArmoredTruck06SpeedType.mph

			// else if _speedType equals ArmoredTruck06SpeedType.kmh
			else if (_speedType == ArmoredTruck06SpeedType.kmh)
			{
			...
			} // close else if _speedType equals ArmoredTruck06SpeedType.kmh
	...
	} // close public class ArmoredTruck06Controller
