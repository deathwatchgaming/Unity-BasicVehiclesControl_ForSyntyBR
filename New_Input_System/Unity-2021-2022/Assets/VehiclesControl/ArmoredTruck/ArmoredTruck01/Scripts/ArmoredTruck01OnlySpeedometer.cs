/*
 * File: Armored Truck 01 Only Speedometer
 * Name: ArmoredTruck01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck01OnlySpeedUnit
	public enum ArmoredTruck01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck01OnlySpeedUnit

	// public class ArmoredTruck01OnlySpeedometer 
	public class ArmoredTruck01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck01OnlySpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals ArmoredTruck01OnlySpeedUnit.mph
			if (_speedUnit == ArmoredTruck01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck01OnlySpeedUnit.mph
	...
	} // close public class ArmoredTruck01OnlySpeedometer
