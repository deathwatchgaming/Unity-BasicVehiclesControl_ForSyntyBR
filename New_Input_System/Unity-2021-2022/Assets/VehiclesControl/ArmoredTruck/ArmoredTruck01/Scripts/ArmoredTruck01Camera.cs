...
namespace VehiclesControl
{
	...
	public class ArmoredTruck01Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck01.InverseTransformDirection(_armoredTruck01.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _armoredTruck01.GetComponent<Rigidbody>().velocity.magnitude;
