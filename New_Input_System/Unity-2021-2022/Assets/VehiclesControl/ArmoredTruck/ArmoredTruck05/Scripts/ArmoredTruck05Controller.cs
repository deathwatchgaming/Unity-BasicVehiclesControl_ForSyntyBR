/*
 * File: Armored Truck 05 Controller (New Input System)
...
namespace VehiclesControl
{
	// public enum ArmoredTruck05SpeedType
	public enum ArmoredTruck05SpeedType
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck05SpeedType
	...
	// public class ArmoredTruck05Controller
	public class ArmoredTruck05Controller : MonoBehaviour
	{
		// Require Components
		...
		[Header("Speed")]
			...
			// ArmoredTruck05SpeedType _speedType	
			[SerializeField] private ArmoredTruck05SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals ArmoredTruck05SpeedType.mph
			if (_speedType == ArmoredTruck05SpeedType.mph)
			{
			...
			} // close if _speedType equals ArmoredTruck05SpeedType.mph

			// else if _speedType equals ArmoredTruck05SpeedType.kmh
			else if (_speedType == ArmoredTruck05SpeedType.kmh)
			{
			...
			} // close else if _speedType equals ArmoredTruck05SpeedType.kmh
	...
	} // close public class ArmoredTruck05Controller
