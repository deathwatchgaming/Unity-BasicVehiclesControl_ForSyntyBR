/*
 * File: TankUS 06 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankUS06Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankUS06BodyRotation.y += _moveInput.x * _tankUS06RotationSpeed;
			...
			_tankUS06TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
