...
namespace VehiclesControl
{
	...
	public class TankUS03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankUS03.InverseTransformDirection(_tankUS03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankUS03.GetComponent<Rigidbody>().velocity.magnitude;
