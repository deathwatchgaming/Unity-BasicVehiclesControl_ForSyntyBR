/*
 * File: TankUS 03 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankUS03Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankUS03BodyRotation.y += _moveInput.x * _tankUS03RotationSpeed;
			...
			_tankUS03TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
