/*
 * File: TankUS 02 Speedometer (New Input System)
 * Name: TankUS02Speedometer.cs
...
namespace VehiclesControl
{
    // public enum TankUS02SpeedUnit
	public enum TankUS02SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankUS02SpeedUnit

	// public class TankUS02Speedometer 
	public class TankUS02Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankUS02SpeedUnit _speedUnit	
			[SerializeField] private TankUS02SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankUS02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankUS02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankUS02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankUS02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankUS02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankUS02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankUS02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankUS02Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals TankUS02SpeedUnit.mph
			if (_speedUnit == TankUS02SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankUS02SpeedUnit.mph
			...
			if (_inTankUS02 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inTankUS02 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class TankUS02Speedometer
