/*
 * File: Sedan 06 Speedometer (New Input System)
 * Name: Sedan06Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan06SpeedUnit
	public enum Sedan06SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan06SpeedUnit

	// public class Sedan06Speedometer 
	public class Sedan06Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan06SpeedUnit _speedUnit	
			[SerializeField] private Sedan06SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Sedan06_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Sedan06_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Sedan06_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Sedan06_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Sedan06_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Sedan06_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Sedan06Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Sedan06Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Sedan06SpeedUnit.mph
			if (_speedUnit == Sedan06SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan06SpeedUnit.mph
	...
	} // close public class Sedan06Speedometer
