/*
 * File: Sedan 06 Controller (New Input System)
...
namespace VehiclesControl
{
	// public enum Sedan06SpeedType
	public enum Sedan06SpeedType
	{
		mph,
		kmh	

	} // close public enum Sedan06SpeedType
	...
	// public class Sedan06Controller
	public class Sedan06Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// Sedan06SpeedType _speedType	
			[SerializeField] private Sedan06SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedan06 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Sedan06SpeedType.mph
			if (_speedType == Sedan06SpeedType.mph)
			{
			...
			} // close if _speedType equals Sedan06SpeedType.mph

			// else if _speedType equals Sedan06SpeedType.kmh
			else if (_speedType == Sedan06SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Sedan06SpeedType.kmh
	...
	} // close public class Sedan06Controller
