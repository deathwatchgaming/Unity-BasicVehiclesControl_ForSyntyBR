/*
 * File: Sedan 04 Controller (New Input System)
 * Name: Sedan04Controller.cs
...
namespace VehiclesControl
{
	// public enum Sedan04SpeedType
	public enum Sedan04SpeedType
	{
		mph,
		kmh	

	} // close public enum Sedan04SpeedType
	...
	// public class Sedan04Controller
	public class Sedan04Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// Sedan04SpeedType _speedType	
			[SerializeField] private Sedan04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedan04 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Sedan04SpeedType.mph
			if (_speedType == Sedan04SpeedType.mph)
			{
			...
			} // close if _speedType equals Sedan04SpeedType.mph

			// else if _speedType equals Sedan04SpeedType.kmh
			else if (_speedType == Sedan04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Sedan04SpeedType.kmh
	...
	} // close public class Sedan04Controller
