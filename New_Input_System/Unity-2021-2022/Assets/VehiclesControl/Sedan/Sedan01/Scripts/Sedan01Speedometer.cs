/*
 * File: Sedan 01 Speedometer (New Input System)
...
namespace VehiclesControl
{
    // public enum Sedan01SpeedUnit
	public enum Sedan01SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan01SpeedUnit

	// public class Sedan01Speedometer 
	public class Sedan01Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan01SpeedUnit _speedUnit	
			[SerializeField] private Sedan01SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Sedan01_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Sedan01_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Sedan01_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Sedan01_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Sedan01_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Sedan01_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Sedan01Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Sedan01Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Sedan01SpeedUnit.mph
			if (_speedUnit == Sedan01SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan01SpeedUnit.mph
			...
			if (_inSedan01 && _exitButton == true)
			{
				// _inSedan01 is false
				_inSedan01 = false;
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedan01 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Sedan01Speedometer
