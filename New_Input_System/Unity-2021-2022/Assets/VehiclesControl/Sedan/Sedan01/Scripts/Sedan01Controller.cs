/*
 * File: Sedan 01 Controller (New Input System)
 * Name: Sedan01Controller.cs
...
namespace VehiclesControl
{
	// public enum Sedan01SpeedType
	public enum Sedan01SpeedType
	{
		mph,
		kmh	

	} // close public enum Sedan01SpeedType
	...
	// public class Sedan01Controller
	public class Sedan01Controller : MonoBehaviour
	{			
		// Require Components
		...
		[Header("Speed")]
			...
			// Sedan01SpeedType _speedType	
			[SerializeField] private Sedan01SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the sedan01 car from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Sedan01SpeedType.mph
			if (_speedType == Sedan01SpeedType.mph)
			{
			...
			} // close if _speedType equals Sedan01SpeedType.mph

			// else if _speedType equals Sedan01SpeedType.kmh
			else if (_speedType == Sedan01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Sedan01SpeedType.kmh
	...
	} // close public class Sedan01Controller
