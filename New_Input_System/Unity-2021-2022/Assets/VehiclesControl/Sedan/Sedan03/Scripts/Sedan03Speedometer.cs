/*
 * File: Sedan 03 Speedometer (New Input System)
 * Name: Sedan03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Sedan03SpeedUnit
	public enum Sedan03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Sedan03SpeedUnit

	// public class Sedan03Speedometer 
	public class Sedan03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Sedan03SpeedUnit _speedUnit	
			[SerializeField] private Sedan03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Sedan03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Sedan03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Sedan03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Sedan03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Sedan03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Sedan03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Sedan03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Sedan03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Sedan03SpeedUnit.mph
			if (_speedUnit == Sedan03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Sedan03SpeedUnit.mph
			...
			if (_inSedan03 && _exitButton == true)
			{
				// _inSedan03 is false
				_inSedan03 = false;
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSedan03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Sedan03Speedometer
