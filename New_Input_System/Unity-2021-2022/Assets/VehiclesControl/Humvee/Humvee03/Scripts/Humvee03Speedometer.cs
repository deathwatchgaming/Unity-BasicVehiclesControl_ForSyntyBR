/*
 * File: Humvee 03 Speedometer (New Input System)
 * Name: Humvee03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee03SpeedUnit
	public enum Humvee03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee03SpeedUnit

	// public class Humvee03Speedometer 
	public class Humvee03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee03SpeedUnit _speedUnit	
			[SerializeField] private Humvee03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName Humvee03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("Humvee03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName Humvee03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("Humvee03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName Humvee03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("Humvee03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName Humvee03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("Humvee03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals Humvee03SpeedUnit.mph
			if (_speedUnit == Humvee03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee03SpeedUnit.mph
			...
			if (_inHumvee03 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inHumvee03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class Humvee03Speedometer
