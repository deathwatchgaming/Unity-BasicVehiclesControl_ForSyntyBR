...
namespace VehiclesControl
{
	...
	public class Humvee02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee02.InverseTransformDirection(_humvee02.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _humvee02.GetComponent<Rigidbody>().velocity.magnitude;
