/*
 * File: Humvee 02 Controller (New Input System)
 * Name: Humvee02Controller.cs
...
namespace VehiclesControl
{
	// public enum Humvee02SpeedType
	public enum Humvee02SpeedType
	{
		mph,
		kmh	

	} // close public enum Humvee02SpeedType
	...
	// public class Humvee02Controller
	public class Humvee02Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Humvee02SpeedType _speedType	
			[SerializeField] private Humvee02SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Humvee02 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Humvee02SpeedType.mph
			if (_speedType == Humvee02SpeedType.mph)
			{
			...
			} // close if _speedType equals Humvee02SpeedType.mph

			// else if _speedType equals Humvee02SpeedType.kmh
			else if (_speedType == Humvee02SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Humvee02SpeedType.kmh
	...
	} // close public class Humvee02Controller
