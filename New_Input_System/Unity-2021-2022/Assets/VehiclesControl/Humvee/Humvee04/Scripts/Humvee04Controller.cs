/*
 * File: Humvee 04 Controller (New Input System)
 * Name: Humvee04Controller.cs
...
namespace VehiclesControl
{
	// public enum Humvee04SpeedType
	public enum Humvee04SpeedType
	{
		mph,
		kmh	

	} // close public enum Humvee04SpeedType
	...
	// public class Humvee04Controller
	public class Humvee04Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Humvee04SpeedType _speedType	
			[SerializeField] private Humvee04SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Humvee04 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Humvee04SpeedType.mph
			if (_speedType == Humvee04SpeedType.mph)
			{
			...
			} // close if _speedType equals Humvee04SpeedType.mph

			// else if _speedType equals Humvee04SpeedType.kmh
			else if (_speedType == Humvee04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Humvee04SpeedType.kmh
	...
	} // close public class Humvee04Controller
