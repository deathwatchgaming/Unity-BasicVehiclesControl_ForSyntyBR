/*
 * File: Humvee 04 Only Speedometer
 * Name: Humvee04OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee04OnlySpeedUnit
	public enum Humvee04OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee04OnlySpeedUnit

	// public class Humvee04OnlySpeedometer 
	public class Humvee04OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee04OnlySpeedUnit _speedUnit	
			[SerializeField] private Humvee04OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Humvee04OnlySpeedUnit.mph
			if (_speedUnit == Humvee04OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee04OnlySpeedUnit.mph
	...
	} // close public class Humvee04OnlySpeedometer
