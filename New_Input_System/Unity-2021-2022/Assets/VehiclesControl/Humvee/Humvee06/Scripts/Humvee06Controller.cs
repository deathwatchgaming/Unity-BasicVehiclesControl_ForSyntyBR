/*
 * File: Humvee 06 Controller (New Input System)
 * Name: Humvee06Controller.cs
...
namespace VehiclesControl
{
	// public enum Humvee06SpeedType
	public enum Humvee06SpeedType
	{
		mph,
		kmh	

	} // close public enum Humvee06SpeedType
	...
	// public class Humvee06Controller
	public class Humvee06Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// Humvee06SpeedType _speedType	
			[SerializeField] private Humvee06SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// Adjust the center of mass vertically to help prevent the Humvee06 from rolling
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals Humvee06SpeedType.mph
			if (_speedType == Humvee06SpeedType.mph)
			{
			...
			} // close if _speedType equals Humvee06SpeedType.mph

			// else if _speedType equals Humvee06SpeedType.kmh
			else if (_speedType == Humvee06SpeedType.kmh)
			{
			...
			} // close else if _speedType equals Humvee06SpeedType.kmh
	...
	} // close public class Humvee06Controller
