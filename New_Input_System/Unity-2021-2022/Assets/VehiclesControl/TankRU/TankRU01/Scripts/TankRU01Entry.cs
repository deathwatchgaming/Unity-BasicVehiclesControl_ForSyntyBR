/*
 * File: Tank RU 01 Entry (New Input System) 
...
namespace VehiclesControl
{
    ...
    {   
        ...
        [Header("Compass")]
            ...
            [Tooltip("The tankRU 01 compass")]
            // TankRU01Compass _tankRU01Compass
            [SerializeField] private TankRU01Compass _tankRU01Compass;
        ...
        //public static TankRU01Entry _tankRU01Entry;
        ...
        private void Start() 
        {
            ...
            // _tankRU01Compass enabled is false
            _tankRU01Compass.enabled = false;

            // _tankRU01Compass compassEnabled is false
            _tankRU01Compass.compassEnabled = false;
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (!_inTankRU01 && other.gameObject.tag == "Player" && _enterButton == true)
            {
                ...
                // _tankRU01Compass enabled is true
                _tankRU01Compass.enabled = true;

                // _tankRU01Compass compassEnabled is true
                _tankRU01Compass.compassEnabled = true;
