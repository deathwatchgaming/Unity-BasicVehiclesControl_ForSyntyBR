/*
 * File: Tank RU 05 Speedometer (New Input System)
 * Name: TankRU05Speedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU05SpeedUnit
	public enum TankRU05SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU05SpeedUnit

	// public class TankRU05Speedometer 
	public class TankRU05Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU05SpeedUnit _speedUnit	
			[SerializeField] private TankRU05SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankRU05_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankRU05_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankRU05_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankRU05_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankRU05_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankRU05_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankRU05Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankRU05Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals TankRU05SpeedUnit.mph
			if (_speedUnit == TankRU05SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU05SpeedUnit.mph
			...
			if (_inTankRU05 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inTankRU05 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class TankRU05Speedometer
