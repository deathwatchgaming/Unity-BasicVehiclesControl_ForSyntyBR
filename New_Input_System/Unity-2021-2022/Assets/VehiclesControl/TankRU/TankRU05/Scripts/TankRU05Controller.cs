/*
 * File: Tank RU 05 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankRU05Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankRU05BodyRotation.y += _moveInput.x * _tankRU05RotationSpeed;
			...
			_tankRU05TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
