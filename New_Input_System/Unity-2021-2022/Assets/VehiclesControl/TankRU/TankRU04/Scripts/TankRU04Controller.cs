/*
 * File: Tank RU 04 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankRU04Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankRU04BodyRotation.y += _moveInput.x * _tankRU04RotationSpeed;
			...
			_tankRU04TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
