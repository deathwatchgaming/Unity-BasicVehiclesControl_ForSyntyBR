/*
 * File: TankRU 02 Only Speedometer
 * Name: TankRU02OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU02OnlySpeedUnit
	public enum TankRU02OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU02OnlySpeedUnit

	// public class TankRU02OnlySpeedometer 
	public class TankRU02OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU02OnlySpeedUnit _speedUnit	
			[SerializeField] private TankRU02OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankRU02OnlySpeedUnit.mph
			if (_speedUnit == TankRU02OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU02OnlySpeedUnit.mph
	...
	} // close public class TankRU02OnlySpeedometer
