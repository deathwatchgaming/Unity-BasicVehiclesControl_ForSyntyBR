/*
 * File: Tank RU 02 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankRU02Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankRU02BodyRotation.y += _moveInput.x * _tankRU02RotationSpeed;
			...
			_tankRU02TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
