...
namespace VehiclesControl
{
	...
	public class TankRU03Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankRU03.InverseTransformDirection(_tankRU03.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankRU03.GetComponent<Rigidbody>().velocity.magnitude;
