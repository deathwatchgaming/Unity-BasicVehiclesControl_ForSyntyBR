/*
 * File: Tank RU 06 Speedometer (New Input System)
 * Name: TankRU06Speedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU06SpeedUnit
	public enum TankRU06SpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU06SpeedUnit

	// public class TankRU06Speedometer 
	public class TankRU06Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU06SpeedUnit _speedUnit	
			[SerializeField] private TankRU06SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName TankRU06_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("TankRU06_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName TankRU06_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("TankRU06_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName TankRU06_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("TankRU06_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName TankRU06Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("TankRU06Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals TankRU06SpeedUnit.mph
			if (_speedUnit == TankRU06SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU06SpeedUnit.mph
			...
			if (_inTankRU06 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inTankRU06 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class TankRU06Speedometer
