...
namespace VehiclesControl
{
	...
	public class TankRU06Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _tankRU06.InverseTransformDirection(_tankRU06.GetComponent<Rigidbody>().velocity);
			...
			float _autoCamControl = _tankRU06.GetComponent<Rigidbody>().velocity.magnitude;
