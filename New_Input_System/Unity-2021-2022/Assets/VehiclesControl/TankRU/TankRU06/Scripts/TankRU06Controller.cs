/*
 * File: Tank RU 06 Controller (New Input System)
...
namespace VehiclesControl
{
	...
	public class TankRU06Controller : MonoBehaviour
	{
		...
		private void HandleSteering()
		{
			...
			_tankRU06BodyRotation.y += _moveInput.x * _tankRU06RotationSpeed;
			...
			_tankRU06TurretRotation.y += _moveTurretInput.x * _turretRotationSpeed;
