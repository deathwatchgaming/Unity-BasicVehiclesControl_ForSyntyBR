/*
 * File: Six Wheel Truck 02 Entry (New Input System)
...
namespace VehiclesControl
{
    ...
    {   
        ...
        [Header("Compass")]
            ...
            [Tooltip("The sixWheelTruck 02 compass")]
            // SixWheelTruck02Compass _sixWheelTruck02Compass
            [SerializeField] private SixWheelTruck02Compass _sixWheelTruck02Compass;
        ...
        //public static SixWheelTruck02Entry _sixWheelTruck02Entry;
        ...
        private void Start() 
        {
            ...
            // _sixWheelTruck02Compass enabled is false
            _sixWheelTruck02Compass.enabled = false;

            // _sixWheelTruck02Compass compassEnabled is false
            _sixWheelTruck02Compass.compassEnabled = false;
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (!_inSixWheelTruck02 && other.gameObject.tag == "Player" && _enterButton == true)
            {
                ...
                // _sixWheelTruck02Compass enabled is true
                _sixWheelTruck02Compass.enabled = true;

                // _sixWheelTruck02Compass compassEnabled is true
                _sixWheelTruck02Compass.compassEnabled = true;
