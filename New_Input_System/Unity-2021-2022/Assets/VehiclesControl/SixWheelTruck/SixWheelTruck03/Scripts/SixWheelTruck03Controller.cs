/*
 * File: Six Wheel Truck 03 Controller (New Input System)
 * Name: SixWheelTruck03Controller.cs
...
namespace VehiclesControl
{
	// public enum SixWheelTruck03SpeedType
	public enum SixWheelTruck03SpeedType
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck03SpeedType
	...
	// public class SixWheelTruck03Controller
	public class SixWheelTruck03Controller : MonoBehaviour
	{					    		
		// Require Components
		...
		[Header("Speed")]
			...
			// SixWheelTruck03SpeedType _speedType	
			[SerializeField] private SixWheelTruck03SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SixWheelTruck03SpeedType.mph
			if (_speedType == SixWheelTruck03SpeedType.mph)
			{
			...
			} // close if _speedType equals SixWheelTruck03SpeedType.mph

			// else if _speedType equals SixWheelTruck03SpeedType.kmh
			else if (_speedType == SixWheelTruck03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SixWheelTruck03SpeedType.kmh
	...
	} // close public class SixWheelTruck03Controller
