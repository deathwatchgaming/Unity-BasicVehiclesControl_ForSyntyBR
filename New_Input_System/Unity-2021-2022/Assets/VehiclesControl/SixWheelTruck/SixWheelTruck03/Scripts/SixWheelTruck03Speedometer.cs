/*
 * File: Six Wheel Truck 03 Speedometer (New Input System)
 * Name: SixWheelTruck03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum SixWheelTruck03SpeedUnit
	public enum SixWheelTruck03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck03SpeedUnit

	// public class SixWheelTruck03Speedometer 
	public class SixWheelTruck03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck03SpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SixWheelTruck03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SixWheelTruck03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SixWheelTruck03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SixWheelTruck03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SixWheelTruck03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SixWheelTruck03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SixWheelTruck03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SixWheelTruck03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SixWheelTruck03SpeedUnit.mph
			if (_speedUnit == SixWheelTruck03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck03SpeedUnit.mph
			...
			if (_inSixWheelTruck03 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inSixWheelTruck03 && other.gameObject.tag == "Player" && _enterButton == true)
			{
	...
	} // close public class SixWheelTruck03Speedometer
