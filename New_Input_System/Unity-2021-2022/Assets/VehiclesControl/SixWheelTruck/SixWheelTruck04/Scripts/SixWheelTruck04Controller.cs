/*
 * File: Six Wheel Truck 04 Controller (New Input System)
...
namespace VehiclesControl
{
	// public enum SixWheelTruck04SpeedType
	public enum SixWheelTruck04SpeedType
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck04SpeedType
	...
	// public class SixWheelTruck04Controller
	public class SixWheelTruck04Controller : MonoBehaviour
	{					    		
		// Require Components
		...
		[Header("Speed")]
			...
			// SixWheelTruck04SpeedType _speedType	
			[SerializeField] private SixWheelTruck04SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SixWheelTruck04SpeedType.mph
			if (_speedType == SixWheelTruck04SpeedType.mph)
			{
			...
			} // close if _speedType equals SixWheelTruck04SpeedType.mph

			// else if _speedType equals SixWheelTruck04SpeedType.kmh
			else if (_speedType == SixWheelTruck04SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SixWheelTruck04SpeedType.kmh
	...
	} // close public class SixWheelTruck04Controller
