/*
 * File: Six Wheel Truck 01 Controller (New Input System)
 * Name: SixWheelTruck01Controller.cs
...
namespace VehiclesControl
{
	// public enum SixWheelTruck01SpeedType
	public enum SixWheelTruck01SpeedType
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck01SpeedType
	...
	// public class SixWheelTruck01Controller
	public class SixWheelTruck01Controller : MonoBehaviour
	{					    		
		// Require Components
		...
		[Header("Speed")]
			...
			// SixWheelTruck01SpeedType _speedType	
			[SerializeField] private SixWheelTruck01SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals SixWheelTruck01SpeedType.mph
			if (_speedType == SixWheelTruck01SpeedType.mph)
			{
			...
			} // close if _speedType equals SixWheelTruck01SpeedType.mph

			// else if _speedType equals SixWheelTruck01SpeedType.kmh
			else if (_speedType == SixWheelTruck01SpeedType.kmh)
			{
			...
			} // close else if _speedType equals SixWheelTruck01SpeedType.kmh
	...
	} // close public class SixWheelTruck01Controller
