/*
 * File: Six Wheel Truck 06 Speedometer (New Input System)
...
namespace VehiclesControl
{
    // public enum SixWheelTruck06SpeedUnit
	public enum SixWheelTruck06SpeedUnit
	{
		mph,
		kmh	

	} // close public enum SixWheelTruck06SpeedUnit

	// public class SixWheelTruck06Speedometer 
	public class SixWheelTruck06Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// SixWheelTruck06SpeedUnit _speedUnit	
			[SerializeField] private SixWheelTruck06SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName SixWheelTruck06_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("SixWheelTruck06_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName SixWheelTruck06_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("SixWheelTruck06_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName SixWheelTruck06_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("SixWheelTruck06_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName SixWheelTruck06Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("SixWheelTruck06Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals SixWheelTruck06SpeedUnit.mph
			if (_speedUnit == SixWheelTruck06SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals SixWheelTruck06SpeedUnit.mph
	...
	} // close public class SixWheelTruck06Speedometer
