/*
 * File: Dune Buggy 06 Controller (New Input System)
 * Name: DuneBuggy06Controller.cs
...
namespace VehiclesControl
{
	// public enum DuneBuggy06SpeedType
	public enum DuneBuggy06SpeedType
	{
		mph,
		kmh	

	} // close public enum DuneBuggy06SpeedType
	...
	// public class DuneBuggy06Controller
	public class DuneBuggy06Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// DuneBuggy06SpeedType _speedType	
			[SerializeField] private DuneBuggy06SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals DuneBuggy06SpeedType.mph
			if (_speedType == DuneBuggy06SpeedType.mph)
			{
			...
			} // close if _speedType equals DuneBuggy06SpeedType.mph

			// else if _speedType equals DuneBuggy06SpeedType.kmh
			else if (_speedType == DuneBuggy06SpeedType.kmh)
			{
			...
			} // close else if _speedType equals DuneBuggy06SpeedType.kmh
	...
	} // close public class DuneBuggy06Controller
