/*
 * File: Dune Buggy 03 Speedometer (New Input System)
 * Name: DuneBuggy03Speedometer.cs
...
namespace VehiclesControl
{
    // public enum DuneBuggy03SpeedUnit
	public enum DuneBuggy03SpeedUnit
	{
		mph,
		kmh	

	} // close public enum DuneBuggy03SpeedUnit

	// public class DuneBuggy03Speedometer 
	public class DuneBuggy03Speedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// DuneBuggy03SpeedUnit _speedUnit	
			[SerializeField] private DuneBuggy03SpeedUnit _speedUnit;
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName DuneBuggy03_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("DuneBuggy03_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName DuneBuggy03_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("DuneBuggy03_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName DuneBuggy03_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("DuneBuggy03_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName DuneBuggy03Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("DuneBuggy03Speedometer");
		...
		private void Update()
		{
			...
			// if _speedUnit equals DuneBuggy03SpeedUnit.mph
			if (_speedUnit == DuneBuggy03SpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals DuneBuggy03SpeedUnit.mph
	...
	} // close public class DuneBuggy03Speedometer
