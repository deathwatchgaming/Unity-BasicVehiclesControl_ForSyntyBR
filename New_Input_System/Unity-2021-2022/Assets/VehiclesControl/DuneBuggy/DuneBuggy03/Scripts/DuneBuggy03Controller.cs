/*
 * File: Dune Buggy 03 Controller (New Input System)
...
namespace VehiclesControl
{
	// public enum DuneBuggy03SpeedType
	public enum DuneBuggy03SpeedType
	{
		mph,
		kmh	

	} // close public enum DuneBuggy03SpeedType
	...
	// public class DuneBuggy03Controller
	public class DuneBuggy03Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// DuneBuggy03SpeedType _speedType	
			[SerializeField] private DuneBuggy03SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals DuneBuggy03SpeedType.mph
			if (_speedType == DuneBuggy03SpeedType.mph)
			{
			...
			} // close if _speedType equals DuneBuggy03SpeedType.mph

			// else if _speedType equals DuneBuggy03SpeedType.kmh
			else if (_speedType == DuneBuggy03SpeedType.kmh)
			{
			...
			} // close else if _speedType equals DuneBuggy03SpeedType.kmh
	...
	} // close public class DuneBuggy03Controller
