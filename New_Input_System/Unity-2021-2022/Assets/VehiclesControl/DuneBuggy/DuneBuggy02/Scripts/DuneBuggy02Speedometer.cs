/*
 * File: Dune Buggy 02 Speedometer (New Input System)
...
namespace VehiclesControl
{
	...
	public class DuneBuggy02Speedometer : MonoBehaviour
	{
		...
		private void Start()
		{
			...
			// GameObject _interfaceIMG01Object is FindInActiveObjectByName DuneBuggy02_SpeedoGuage
			GameObject _interfaceIMG01Object = FindInActiveObjectByName("DuneBuggy02_SpeedoGuage");

			// _interfaceIMG01Object SetActive is false
			_interfaceIMG01Object.SetActive(false);

			// GameObject _interfaceIMG02Object is FindInActiveObjectByName DuneBuggy02_SpeedoNeedle
			GameObject _interfaceIMG02Object = FindInActiveObjectByName("DuneBuggy02_SpeedoNeedle");

			// _interfaceIMG02Object SetActive is false
			_interfaceIMG02Object.SetActive(false);	

			// GameObject _interfaceTextObject is FindInActiveObjectByName DuneBuggy02_SpeedText
			GameObject _interfaceTextObject = FindInActiveObjectByName("DuneBuggy02_SpeedText");

			// _interfaceTextObject SetActive is false
			_interfaceTextObject.SetActive(false);			

			// GameObject _interfaceParentObject is FindInActiveObjectByName DuneBuggy02Speedometer
			GameObject _interfaceParentObject = FindInActiveObjectByName("DuneBuggy02Speedometer");
		...
		private void Update()
		{
			...
			if (_inDuneBuggy02 && _exitButton == true)
			{
		...
		private void OnTriggerStay(Collider other)
		{
			...
			if (!_inDuneBuggy02 && other.gameObject.tag == "Player" && _enterButton == true)
			{
