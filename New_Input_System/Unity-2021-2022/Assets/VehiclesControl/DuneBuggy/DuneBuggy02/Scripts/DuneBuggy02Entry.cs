/*
 * File: Dune Buggy 02 Entry (New Input System) 
...
namespace VehiclesControl
{
    ...
    public class DuneBuggy02Entry : MonoBehaviour
    {
        ...
        [Header("Compass")]
            ...
            [Tooltip("The duneBuggy 02 compass")]
            // DuneBuggy02Compass _duneBuggy02Compass
            [SerializeField] private DuneBuggy02Compass _duneBuggy02Compass;
        ...
        //public static DuneBuggy02Entry _duneBuggy02Entry;
        ...
        private void Start() 
        {
            ...
            // _duneBuggy02Compass enabled is false
            _duneBuggy02Compass.enabled = false;

            // _duneBuggy02Compass compassEnabled is false
            _duneBuggy02Compass.compassEnabled = false;
        ...
        private void OnTriggerStay(Collider other)
        {
            ...
            if (!_inDuneBuggy02 && other.gameObject.tag == "Player" && _enterButton == true)
            {
                ...
                // _duneBuggy02Compass enabled is true
                _duneBuggy02Compass.enabled = true;

                // _duneBuggy02Compass compassEnabled is true
                _duneBuggy02Compass.compassEnabled = true;
