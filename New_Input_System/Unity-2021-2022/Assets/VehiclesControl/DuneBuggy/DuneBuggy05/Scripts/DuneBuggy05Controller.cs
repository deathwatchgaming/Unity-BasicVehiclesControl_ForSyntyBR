/*
 * File: Dune Buggy 05 Controller (New Input System)
 * Name: DuneBuggy05Controller.cs
...
namespace VehiclesControl
{
	// public enum DuneBuggy05SpeedType
	public enum DuneBuggy05SpeedType
	{
		mph,
		kmh	

	} // close public enum DuneBuggy05SpeedType
	...
	// public class DuneBuggy05Controller
	public class DuneBuggy05Controller : MonoBehaviour
	{					
		// Require Components
		...
		[Header("Speed")]
			...
			// DuneBuggy05SpeedType _speedType	
			[SerializeField] private DuneBuggy05SpeedType _speedType;			
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals DuneBuggy05SpeedType.mph
			if (_speedType == DuneBuggy05SpeedType.mph)
			{
			...
			} // close if _speedType equals DuneBuggy05SpeedType.mph

			// else if _speedType equals DuneBuggy05SpeedType.kmh
			else if (_speedType == DuneBuggy05SpeedType.kmh)
			{
			...
			} // close else if _speedType equals DuneBuggy05SpeedType.kmh
	...
	} // close public class DuneBuggy05Controller
