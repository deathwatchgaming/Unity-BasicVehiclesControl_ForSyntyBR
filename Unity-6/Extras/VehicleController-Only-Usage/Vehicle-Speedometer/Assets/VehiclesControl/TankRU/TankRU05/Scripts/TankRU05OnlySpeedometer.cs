/*
 * File: TankRU 05 Only Speedometer
 * Name: TankRU05OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum TankRU05OnlySpeedUnit
	public enum TankRU05OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum TankRU05OnlySpeedUnit

	// public class TankRU05OnlySpeedometer 
	public class TankRU05OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// TankRU05OnlySpeedUnit _speedUnit	
			[SerializeField] private TankRU05OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals TankRU05OnlySpeedUnit.mph
			if (_speedUnit == TankRU05OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals TankRU05OnlySpeedUnit.mph
	...
	} // close public class TankRU05OnlySpeedometer
