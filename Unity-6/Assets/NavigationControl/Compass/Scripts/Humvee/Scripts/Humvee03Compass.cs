/*
*  Name: Humvee 03 Compass
*  File: Humvee03Compass.cs
...
namespace NavigationControl
{
	// public class Humvee03Compass
	public class Humvee03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Humvee03 transform")]
			// Transform _humvee03
			[SerializeField] private Transform _humvee03;
		...
		public static Humvee03Compass _humvee03Compass;

		// private void Start
		private void Start()
		{
			// _humvee03Compass
			_humvee03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Humvee03Compass is enabled
				GetComponent<Humvee03Compass>().enabled = true;

				// Debug Log Humvee03 compass is enabled
			...
			{
				// Debug Log Humvee03 compass is disabled
				...
				// Get Component Humvee03Compass is not enabled
				GetComponent<Humvee03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _humvee03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_humvee03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _humvee03 forward vector

			// Vector3 forward is _humvee03 transform forward
			Vector3 forward = _humvee03.transform.forward;

			// Zero out the Y of _humvee03 forward vector to only get the direction in the X,Z 
	...
	} // close public class Humvee03Compass
