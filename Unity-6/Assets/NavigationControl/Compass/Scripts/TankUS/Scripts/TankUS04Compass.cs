/*
*  Name: Tank US 04 Compass
*  File: TankUS04Compass.cs
...
namespace NavigationControl
{
	// public class TankUS04Compass
	public class TankUS04Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The TankUS04 transform")]
			// Transform _tankUS04
		...
		public static TankUS04Compass _tankUS04Compass;

		// private void Start
		private void Start()
		{
			// _tankUS04Compass
			_tankUS04Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component TankUS04Compass is enabled
				GetComponent<TankUS04Compass>().enabled = true;

				// Debug Log TankUS04 compass is enabled
			...
			{
				// Debug Log TankUS04 compass is disabled
				...
				// Get Component TankUS04Compass is not enabled
				GetComponent<TankUS04Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _tankUS04 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_tankUS04.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _tankUS04 forward vector

			// Vector3 forward is _tankUS04 transform forward
			Vector3 forward = _tankUS04.transform.forward;

			// Zero out the Y of _tankUS04 forward vector to only get the direction in the X,Z 
	...
	} // close public class TankUS04Compass
