/*
*  Name: Dune Buggy 03 Compass
*  File: DuneBuggy03Compass.cs
...
namespace NavigationControl
{
	// public class DuneBuggy03Compass
	public class DuneBuggy03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The DuneBuggy03 transform")]
		...
		public static DuneBuggy03Compass _duneBuggy03Compass;

		// private void Start
		private void Start()
		{
			// _duneBuggy03Compass
			_duneBuggy03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component DuneBuggy03Compass is enabled
				GetComponent<DuneBuggy03Compass>().enabled = true;

				// Debug Log DuneBuggy03 compass is enabled
			...
			{
				// Debug Log DuneBuggy03 compass is disabled
				...
				// Get Component DuneBuggy03Compass is not enabled
				GetComponent<DuneBuggy03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _duneBuggy03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_duneBuggy03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _duneBuggy03 forward vector

			// Vector3 forward is _duneBuggy03 transform forward
			Vector3 forward = _duneBuggy03.transform.forward;

			// Zero out the Y of _duneBuggy03 forward vector to only get the direction in the X,Z 
	...
	} // close public class DuneBuggy03Compass
