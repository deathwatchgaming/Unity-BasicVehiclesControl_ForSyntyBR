/*
*  Name: Six Wheel Truck 03 Compass
*  File: SixWheelTruck03Compass.cs
...
namespace NavigationControl
{
	// public class SixWheelTruck03Compass
	public class SixWheelTruck03Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The SixWheelTruck03 transform")]
			// Transform _sixWheelTruck03
			[SerializeField] private Transform _sixWheelTruck03;
		...
		public static SixWheelTruck03Compass _sixWheelTruck03Compass;

		// private void Start
		private void Start()
		{
			// _sixWheelTruck03Compass
			_sixWheelTruck03Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component SixWheelTruck03Compass is enabled
				GetComponent<SixWheelTruck03Compass>().enabled = true;

				// Debug Log SixWheelTruck03 compass is enabled
			...
			{
				// Debug Log SixWheelTruck03 compass is disabled
				...
				// Get Component SixWheelTruck03Compass is not enabled
				GetComponent<SixWheelTruck03Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sixWheelTruck03 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sixWheelTruck03.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sixWheelTruck03 forward vector

			// Vector3 forward is _sixWheelTruck03 transform forward
			Vector3 forward = _sixWheelTruck03.transform.forward;

			// Zero out the Y of _sixWheelTruck03 forward vector to only get the direction in the X,Z 
	...
	} // close public class SixWheelTruck03Compass
