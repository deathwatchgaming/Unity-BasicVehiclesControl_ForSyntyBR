/*
*  Name: Sedan 02 Compass
*  File: Sedan02Compass.cs
...
namespace NavigationControl
{
	// public class Sedan02Compass
	public class Sedan02Compass : MonoBehaviour
	{
		// Header
		[Header("Raw Images")]
		...
		[Header("Transform")]
			...
			// Tooltip
			[Tooltip("The Sedan02 transform")]
			// Transform _sedan02
			[SerializeField] private Transform _sedan02;
		...
		public static Sedan02Compass _sedan02Compass;

		// private void Start
		private void Start()
		{
			// _sedan02Compass
			_sedan02Compass = this;
		...
		private void Update()
		{
			...
			if (compassEnabled == true)
			{
				...
				// Get Component Sedan02Compass is enabled
				GetComponent<Sedan02Compass>().enabled = true;

				// Debug Log Sedan02 compass is enabled
			...
			{
				// Debug Log Sedan02 compass is disabled
				...
				// Get Component Sedan02Compass is not enabled
				GetComponent<Sedan02Compass>().enabled = false;

			} // close else if compassEnabled is false

			// Get a handle on the image's uvRect

			// _compassForeground uvRect is new Rect _sedan02 localEulerAngles.y 360, 0, 1, 1
			_compassForeground.uvRect = new Rect(_sedan02.localEulerAngles.y / 360, 0, 1, 1);

			// Get a copy of the _sedan02 forward vector

			// Vector3 forward is _sedan02 transform forward
			Vector3 forward = _sedan02.transform.forward;

			// Zero out the Y of _sedan02 forward vector to only get the direction in the X,Z 
	...
	} // close public class Sedan02Compass
