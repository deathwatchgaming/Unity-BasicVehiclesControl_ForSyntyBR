...
namespace VehiclesControl
{
	...
	public class DuneBuggy06Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _duneBuggy06.InverseTransformDirection(_duneBuggy06.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _duneBuggy06.GetComponent<Rigidbody>().linearVelocity.magnitude;
