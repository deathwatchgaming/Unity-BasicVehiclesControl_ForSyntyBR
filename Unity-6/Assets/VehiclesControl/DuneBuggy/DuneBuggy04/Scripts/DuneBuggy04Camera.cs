/*
 * File: Dune Buggy 04 Camera
 * Name: DuneBuggy04Camera.cs
...
namespace VehiclesControl
{
	// public class DuneBuggy04Camera
	public class DuneBuggy04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The dune buggy 04 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _duneBuggy04.position.y plus _height
			float _desiredHeight = _duneBuggy04.position.y + _height;
			...
			// transform position is _duneBuggy04.position
			transform.position = _duneBuggy04.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _duneBuggy04.InverseTransformDirection(_duneBuggy04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _duneBuggy04.eulerAngles.y plus 180
				_tempVector3.y = _duneBuggy04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _duneBuggy04.eulerAngles.y
				_tempVector3.y = _duneBuggy04.eulerAngles.y;
			...
			float _autoCamControl = _duneBuggy04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class DuneBuggy04Camera
