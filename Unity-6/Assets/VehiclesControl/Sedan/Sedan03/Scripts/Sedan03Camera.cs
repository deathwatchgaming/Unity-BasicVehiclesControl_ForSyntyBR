/*
 * File: Sedan 03 Camera
 * Name: Sedan03Camera.cs
...
namespace VehiclesControl
{
	// public class Sedan03Camera
	public class Sedan03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The sedan 03 transform")]
			// Transform _sedan03
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedan03.position.y plus _height
			float _desiredHeight = _sedan03.position.y + _height;
			...
			// transform position is _sedan03.position
			transform.position = _sedan03.position;
		...
		private void FixedUpdate()
		{
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedan03.eulerAngles.y plus 180
				_tempVector3.y = _sedan03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedan03.eulerAngles.y
				_tempVector3.y = _sedan03.eulerAngles.y;
			...
			float _autoCamControl = _sedan03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Sedan03Camera
