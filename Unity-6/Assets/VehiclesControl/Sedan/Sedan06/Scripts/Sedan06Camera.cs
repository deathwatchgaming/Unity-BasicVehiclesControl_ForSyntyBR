/*
 * File: Sedan 06 Camera
 * Name: Sedan06Camera.cs
...
namespace VehiclesControl
{
	// public class Sedan06Camera
	public class Sedan06Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The sedan 06 transform")]
			// Transform _sedan06
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedan06.position.y plus _height
			float _desiredHeight = _sedan06.position.y + _height;
			...
			// transform position is _sedan06.position
			transform.position = _sedan06.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan06.InverseTransformDirection(_sedan06.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedan06.eulerAngles.y plus 180
				_tempVector3.y = _sedan06.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedan06.eulerAngles.y
				_tempVector3.y = _sedan06.eulerAngles.y;
			...
			float _autoCamControl = _sedan06.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Sedan06Camera
