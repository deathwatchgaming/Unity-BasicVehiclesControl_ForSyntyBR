/*
 * File: Sedan 01 Camera
 * Name: Sedan01Camera.cs
...
namespace VehiclesControl
{
	// public class Sedan01Camera
	public class Sedan01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The sedan 01 transform")]
			// Transform _sedan01
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sedan01.position.y plus _height
			float _desiredHeight = _sedan01.position.y + _height;
			...
			// transform position is _sedan01.position
			transform.position = _sedan01.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sedan01.InverseTransformDirection(_sedan01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sedan01.eulerAngles.y plus 180
				_tempVector3.y = _sedan01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sedan01.eulerAngles.y
				_tempVector3.y = _sedan01.eulerAngles.y;
			...
			float _autoCamControl = _sedan01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Sedan01Camera
