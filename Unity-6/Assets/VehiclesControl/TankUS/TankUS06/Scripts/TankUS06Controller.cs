/*
 * File: TankUS 06 Controller
 * Name: TankUS06Controller.cs
...
namespace VehiclesControl
{
	// public enum TankUS06SpeedType
	public enum TankUS06SpeedType
	{
		mph,
		kmh	

	} // close public enum TankUS06SpeedType
	...
	// public class TankUS06Controller
	public class TankUS06Controller : MonoBehaviour
	{
		...
		// TankUS06 Transforms
		[Header("TankUS06 Transforms")]

			[Tooltip("The tank body transform")]	    
			// _tankUS06Body
			[SerializeField] private Transform _tankUS06Body;

			[Tooltip("The tank turret transform")]	    
			// _tankUS06Turret						
			[SerializeField] private Transform _tankUS06Turret;

			[Tooltip("The tank barrel transform")]	    
			// _tankUS06Barrel					
			[SerializeField] private Transform _tankUS06Barrel;			
		...
		[Header("Amounts")]
			...
			// _tankUS06RotationSpeed is 0.35
			[SerializeField] private float _tankUS06RotationSpeed = 0.35f;
			...
			// Vector3 _tankUS06Rotation
			private Vector3 _tankUS06BodyRotation;

			// Vector3 _tankUS06TurretRotation
			private Vector3 _tankUS06TurretRotation;

		// Speed
		[Header("Speed")]

			[Tooltip("The speed measurement unit")]
			// TankUS06SpeedType _speedType	
			[SerializeField] private TankUS06SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// _tankUS06Rotation is _tankUS06Rotation.transform.eulerAngles
			_tankUS06BodyRotation = _tankUS06Body.transform.eulerAngles;

			// _tankUS06TurretRotation is _tankUS06Turret.transform.eulerAngles
			_tankUS06TurretRotation = _tankUS06Turret.transform.eulerAngles;
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals TankUS06SpeedType.mph
			if (_speedType == TankUS06SpeedType.mph)
			{
			...
			} // close if _speedType equals TankUS06SpeedType.mph

			// else if _speedType equals TankUS06SpeedType.kmh
			else if (_speedType == TankUS06SpeedType.kmh)
			{
			...
			} // close else if _speedType equals TankUS06SpeedType.kmh
		...
		{						
			...
			// _tankUS06Rotation.transform.eulerAngles is _tankUS06Rotation
			_tankUS06Body.transform.eulerAngles = _tankUS06BodyRotation;

			// _tankUS06Rotation.y is Input GetAxis _horizontalMoveInput times _tankUS06RotationSpeed
			_tankUS06BodyRotation.y += Input.GetAxis(_horizontalMoveInput) * _tankUS06RotationSpeed;

			// Take care of the tank turret steering
		
			// _tankUS06Turret.transform.eulerAngles is _tankUS06TurretRotation
			_tankUS06Turret.transform.eulerAngles = _tankUS06TurretRotation;

			// _tankUS06TurretRotation.y is Input GetAxis _mouseXInput times _turretRotationSpeed
			_tankUS06TurretRotation.y += Input.GetAxis(_mouseXInput) * _turretRotationSpeed;
			...
			// _tankUS06Barrel.localRotation is Quaternion Euler _barrelElevation, 0, 0
			_tankUS06Barrel.localRotation = Quaternion.Euler(_barrelElevation, 0, 0);
            
		} // close private void HandleSteering

	} // close public class TankUS06Controller
