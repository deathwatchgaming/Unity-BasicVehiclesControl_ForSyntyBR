/*
 * File: TankUS 01 Camera
 * Name: TankUS01Camera.cs
...
namespace VehiclesControl
{
	// public class TankUS01Camera
	public class TankUS01Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The tankUS01 transform")]
			// Transform _tankUS01
			[SerializeField] private Transform _tankUS01;
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _tankUS01.position.y plus _height
			float _desiredHeight = _tankUS01.position.y + _height;
			...
			// transform position is _tankUS01.position
			transform.position = _tankUS01.position;
		...
		private void FixedUpdate()
		{
			// Vector3 _localVelocity is _tankUS01 InverseTransformDirection _tankUS01 GetComponent Rigidbody velocity
			Vector3 _localVelocity = _tankUS01.InverseTransformDirection(_tankUS01.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _tankUS01.eulerAngles.y plus 180
				_tempVector3.y = _tankUS01.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is_tankUS01.eulerAngles.y
				_tempVector3.y = _tankUS01.eulerAngles.y;
			...
			// float autoCamControl is_tankUS01 GetComponent Rigidbody velocity magnitude
			float _autoCamControl = _tankUS01.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class TankUS01Camera
