/*
 * File: TankUS 05 Controller
 * Name: TankUS05Controller.cs
...
namespace VehiclesControl
{
	// public enum TankUS05SpeedType
	public enum TankUS05SpeedType
	{
		mph,
		kmh	

	} // close public enum TankUS05SpeedType
	...
	// public class TankUS05Controller
	public class TankUS05Controller : MonoBehaviour
	{
		...
		// TankUS05 Transforms
		[Header("TankUS05 Transforms")]

			[Tooltip("The tank body transform")]	    
			// _tankUS05Body
			[SerializeField] private Transform _tankUS05Body;

			[Tooltip("The tank turret transform")]	    
			// _tankUS05Turret						
			[SerializeField] private Transform _tankUS05Turret;

			[Tooltip("The tank barrel transform")]	    
			// _tankUS05Barrel					
			[SerializeField] private Transform _tankUS05Barrel;			
		...
		[Header("Amounts")]
			...
			// _tankUS05RotationSpeed is 0.35
			[SerializeField] private float _tankUS05RotationSpeed = 0.35f;
			...
			// Vector3 _tankUS05Rotation
			private Vector3 _tankUS05BodyRotation;

			// Vector3 _tankUS05TurretRotation
			private Vector3 _tankUS05TurretRotation;

		// Speed
		[Header("Speed")]

			[Tooltip("The speed measurement unit")]
			// TankUS05SpeedType _speedType	
			[SerializeField] private TankUS05SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// _tankUS05Rotation is _tankUS05Rotation.transform.eulerAngles
			_tankUS05BodyRotation = _tankUS05Body.transform.eulerAngles;

			// _tankUS05TurretRotation is _tankUS05Turret.transform.eulerAngles
			_tankUS05TurretRotation = _tankUS05Turret.transform.eulerAngles;
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals TankUS05SpeedType.mph
			if (_speedType == TankUS05SpeedType.mph)
			{
			...
			} // close if _speedType equals TankUS05SpeedType.mph

			// else if _speedType equals TankUS05SpeedType.kmh
			else if (_speedType == TankUS05SpeedType.kmh)
			{
			...
			} // close else if _speedType equals TankUS05SpeedType.kmh
		...
		{						
			...
			// _tankUS05Rotation.transform.eulerAngles is _tankUS05Rotation
			_tankUS05Body.transform.eulerAngles = _tankUS05BodyRotation;

			// _tankUS05Rotation.y is Input GetAxis _horizontalMoveInput times _tankUS05RotationSpeed
			_tankUS05BodyRotation.y += Input.GetAxis(_horizontalMoveInput) * _tankUS05RotationSpeed;

			// Take care of the tank turret steering
		
			// _tankUS05Turret.transform.eulerAngles is _tankUS05TurretRotation
			_tankUS05Turret.transform.eulerAngles = _tankUS05TurretRotation;

			// _tankUS05TurretRotation.y is Input GetAxis _mouseXInput times _turretRotationSpeed
			_tankUS05TurretRotation.y += Input.GetAxis(_mouseXInput) * _turretRotationSpeed;
			...
			// _tankUS05Barrel.localRotation is Quaternion Euler _barrelElevation, 0, 0
			_tankUS05Barrel.localRotation = Quaternion.Euler(_barrelElevation, 0, 0);
            
		} // close private void HandleSteering

	} // close public class TankUS05Controller
