/*
 * File: Six Wheel Truck 03 Camera
 * Name: SixWheelTruck03Camera.cs
...
namespace VehiclesControl
{
	// public class SixWheelTruck03Camera
	public class SixWheelTruck03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The six wheel truck 03 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sixWheelTruck03.position.y plus _height
			float _desiredHeight = _sixWheelTruck03.position.y + _height;
			...
			// transform position is _sixWheelTruck03.position
			transform.position = _sixWheelTruck03.position;
			...
			// transform LookAt _sixWheelTruck03
			transform.LookAt(_sixWheelTruck03);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck03.InverseTransformDirection(_sixWheelTruck03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sixWheelTruck03.eulerAngles.y plus 180
				_tempVector3.y = _sixWheelTruck03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sixWheelTruck03.eulerAngles.y
				_tempVector3.y = _sixWheelTruck03.eulerAngles.y;
			...
			float _autoCamControl = _sixWheelTruck03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SixWheelTruck03Camera
