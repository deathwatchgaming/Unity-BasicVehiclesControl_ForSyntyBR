/*
 * File: Six Wheel Truck 05 Camera
 * Name: SixWheelTruck05Camera.cs
...
namespace VehiclesControl
{
	// public class SixWheelTruck05Camera
	public class SixWheelTruck05Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The six wheel truck 05 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sixWheelTruck05.position.y plus _height
			float _desiredHeight = _sixWheelTruck05.position.y + _height;
			...
			// transform position is _sixWheelTruck05.position
			transform.position = _sixWheelTruck05.position;
			...
			// transform LookAt _sixWheelTruck05
			transform.LookAt(_sixWheelTruck05);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck05.InverseTransformDirection(_sixWheelTruck05.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sixWheelTruck05.eulerAngles.y plus 180
				_tempVector3.y = _sixWheelTruck05.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sixWheelTruck05.eulerAngles.y
				_tempVector3.y = _sixWheelTruck05.eulerAngles.y;
			...
			float _autoCamControl = _sixWheelTruck05.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SixWheelTruck05Camera
