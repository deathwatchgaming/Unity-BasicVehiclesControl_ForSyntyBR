/*
 * File: Six Wheel Truck 06 Camera
 * Name: SixWheelTruck06Camera.cs
...
namespace VehiclesControl
{
	// public class SixWheelTruck06Camera
	public class SixWheelTruck06Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The six wheel truck 06 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _sixWheelTruck06.position.y plus _height
			float _desiredHeight = _sixWheelTruck06.position.y + _height;
			...
			// transform position is _sixWheelTruck06.position
			transform.position = _sixWheelTruck06.position;
			...
			// transform LookAt _sixWheelTruck06
			transform.LookAt(_sixWheelTruck06);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck06.InverseTransformDirection(_sixWheelTruck06.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _sixWheelTruck06.eulerAngles.y plus 180
				_tempVector3.y = _sixWheelTruck06.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _sixWheelTruck06.eulerAngles.y
				_tempVector3.y = _sixWheelTruck06.eulerAngles.y;
			...
			float _autoCamControl = _sixWheelTruck06.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class SixWheelTruck06Camera
