...
namespace VehiclesControl
{
	...
	public class SixWheelTruck02Camera : MonoBehaviour 
	{
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _sixWheelTruck02.InverseTransformDirection(_sixWheelTruck02.GetComponent<Rigidbody>().linearVelocity);
			...
			float _autoCamControl = _sixWheelTruck02.GetComponent<Rigidbody>().linearVelocity.magnitude;
