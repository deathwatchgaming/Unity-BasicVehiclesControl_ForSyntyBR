/*
 * File: Armored Truck 05 Only Speedometer
 * Name: ArmoredTruck05OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum ArmoredTruck05OnlySpeedUnit
	public enum ArmoredTruck05OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum ArmoredTruck05OnlySpeedUnit

	// public class ArmoredTruck05OnlySpeedometer 
	public class ArmoredTruck05OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// ArmoredTruck05OnlySpeedUnit _speedUnit	
			[SerializeField] private ArmoredTruck05OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals ArmoredTruck05OnlySpeedUnit.mph
			if (_speedUnit == ArmoredTruck05OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals ArmoredTruck05OnlySpeedUnit.mph
	...
	} // close public class ArmoredTruck05OnlySpeedometer
