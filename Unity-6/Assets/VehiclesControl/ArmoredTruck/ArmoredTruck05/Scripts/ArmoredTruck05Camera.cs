/*
 * File: Armored Truck 05 Camera
 * Name: ArmoredTruck05Camera.cs
...
namespace VehiclesControl
{
	...
	public class ArmoredTruck05Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The armored truck 05 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _armoredTruck05.position.y plus _height
			float _desiredHeight = _armoredTruck05.position.y + _height;
			...
			// transform position is _armoredTruck05.position
			transform.position = _armoredTruck05.position;
			...
			// transform LookAt _armoredTruck05
			transform.LookAt(_armoredTruck05);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck05.InverseTransformDirection(_armoredTruck05.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _armoredTruck05.eulerAngles.y plus 180
				_tempVector3.y = _armoredTruck05.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _armoredTruck05.eulerAngles.y
				_tempVector3.y = _armoredTruck05.eulerAngles.y;
			...
			float _autoCamControl = _armoredTruck05.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class ArmoredTruck05Camera
