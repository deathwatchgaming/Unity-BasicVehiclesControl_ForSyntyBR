/*
 * File: Armored Truck 04 Camera
 * Name: ArmoredTruck04Camera.cs
...
namespace VehiclesControl
{
	...
	public class ArmoredTruck04Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The armored truck 04 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _armoredTruck04.position.y plus _height
			float _desiredHeight = _armoredTruck04.position.y + _height;
			...
			// transform position is _armoredTruck04.position
			transform.position = _armoredTruck04.position;
			...
			// transform LookAt _armoredTruck04
			transform.LookAt(_armoredTruck04);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck04.InverseTransformDirection(_armoredTruck04.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _armoredTruck04.eulerAngles.y plus 180
				_tempVector3.y = _armoredTruck04.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _armoredTruck04.eulerAngles.y
				_tempVector3.y = _armoredTruck04.eulerAngles.y;
			...
			float _autoCamControl = _armoredTruck04.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class ArmoredTruck04Camera
