/*
 * File: Armored Truck 06 Camera
 * Name: ArmoredTruck06Camera.cs
...
namespace VehiclesControl
{
	...
	public class ArmoredTruck06Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The armored truck 06 transform")]
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _armoredTruck06.position.y plus _height
			float _desiredHeight = _armoredTruck06.position.y + _height;
			...
			// transform position is _armoredTruck06.position
			transform.position = _armoredTruck06.position;
			...
			// transform LookAt _armoredTruck06
			transform.LookAt(_armoredTruck06);
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _armoredTruck06.InverseTransformDirection(_armoredTruck06.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _armoredTruck06.eulerAngles.y plus 180
				_tempVector3.y = _armoredTruck06.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _armoredTruck06.eulerAngles.y
				_tempVector3.y = _armoredTruck06.eulerAngles.y;
			...
			float _autoCamControl = _armoredTruck06.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class ArmoredTruck06Camera
