...
namespace VehiclesControl
{
	// public class Humvee03Camera
	public class Humvee03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The humvee 03 transform")]
			// Transform _humvee03
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _humvee03.position.y plus _height
			float _desiredHeight = _humvee03.position.y + _height;
			...
			// transform position is _humvee03.position
			transform.position = _humvee03.position;
		...
		private void FixedUpdate()
		{
			...
			Vector3 _localVelocity = _humvee03.InverseTransformDirection(_humvee03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _humvee03.eulerAngles.y plus 180
				_tempVector3.y = _humvee03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is _humvee03.eulerAngles.y
				_tempVector3.y = _humvee03.eulerAngles.y;
			...
			float _autoCamControl = _humvee03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class Humvee03Camera
