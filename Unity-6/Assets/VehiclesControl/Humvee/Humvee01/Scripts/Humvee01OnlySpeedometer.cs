/*
 * File: Humvee 01 Only Speedometer
 * Name: Humvee01OnlySpeedometer.cs
...
namespace VehiclesControl
{
    // public enum Humvee01OnlySpeedUnit
	public enum Humvee01OnlySpeedUnit
	{
		mph,
		kmh	

	} // close public enum Humvee01OnlySpeedUnit

	// public class Humvee01OnlySpeedometer 
	public class Humvee01OnlySpeedometer : MonoBehaviour
	{
		// Speedometer
		[Header("Speedometer")]
		...
		[Header("Speed Text")]
			...
			// Humvee01OnlySpeedUnit _speedUnit	
			[SerializeField] private Humvee01OnlySpeedUnit _speedUnit;
		...
		private void Update()
		{
			// if _speedUnit equals Humvee01OnlySpeedUnit.mph
			if (_speedUnit == Humvee01OnlySpeedUnit.mph)
			{
			...
			} // close if _speedUnit equals Humvee01OnlySpeedUnit.mph
	...
	} // close public class Humvee01OnlySpeedometer
