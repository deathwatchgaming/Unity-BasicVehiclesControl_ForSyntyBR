/*
 * File: Tank RU 03 Camera
 * Name: TankRU03Camera.cs
...
namespace VehiclesControl
{
	// public class TankRU03Camera
	public class TankRU03Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The tank ru 03 transform")]
			// Transform _tankRU03
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _tankRU03.position.y plus _height
			float _desiredHeight = _tankRU03.position.y + _height;
			...
			// transform position is _tankRU03.position
			transform.position = _tankRU03.position;
		...
		private void FixedUpdate()
		{
			// Vector3 _localVelocity is _tankRU03 InverseTransformDirection _tankRU03 GetComponent Rigidbody velocity
			Vector3 _localVelocity = _tankRU03.InverseTransformDirection(_tankRU03.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _tankRU03.eulerAngles.y plus 180
				_tempVector3.y = _tankRU03.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is_tankRU03.eulerAngles.y
				_tempVector3.y = _tankRU03.eulerAngles.y;
			...
			// float autoCamControl is_tankRU03 GetComponent Rigidbody velocity magnitude
			float _autoCamControl = _tankRU03.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class TankRU03Camera
