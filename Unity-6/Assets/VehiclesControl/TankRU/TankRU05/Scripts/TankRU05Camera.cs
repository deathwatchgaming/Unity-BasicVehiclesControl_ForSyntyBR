/*
 * File: Tank RU 05 Camera
 * Name: TankRU05Camera.cs
...
namespace VehiclesControl
{
	// public class TankRU05Camera
	public class TankRU05Camera : MonoBehaviour 
	{
		// Transforms
		[Header("Transforms")]

			[Tooltip("The tank ru 05 transform")]
			// Transform _tankRU05
		...
		private void LateUpdate()
		{
			...
			// float _desiredHeight is _tankRU05.position.y plus _height
			float _desiredHeight = _tankRU05.position.y + _height;
			...
			// transform position is _tankRU05.position
			transform.position = _tankRU05.position;
		...
		private void FixedUpdate()
		{
			// Vector3 _localVelocity is _tankRU05 InverseTransformDirection _tankRU05 GetComponent Rigidbody velocity
			Vector3 _localVelocity = _tankRU05.InverseTransformDirection(_tankRU05.GetComponent<Rigidbody>().linearVelocity);
			...
			if (_localVelocity.z < -0.1f)
			{
				...
				// _tempVector3.y is _tankRU05.eulerAngles.y plus 180
				_tempVector3.y = _tankRU05.eulerAngles.y + 180;
			...
			else
			{
				...
				// _tempVector3 y is_tankRU05.eulerAngles.y
				_tempVector3.y = _tankRU05.eulerAngles.y;
			...
			float _autoCamControl = _tankRU05.GetComponent<Rigidbody>().linearVelocity.magnitude;
	...
	} // close public class TankRU05Camera
