/*
 * File: Tank RU 05 Controller
 * Name: TankRU05Controller.cs
...
namespace VehiclesControl
{
	// public enum TankRU05SpeedType
	public enum TankRU05SpeedType
	{
		mph,
		kmh	

	} // close public enum TankRU05SpeedType
	...
	// public class TankRU05Controller
	public class TankRU05Controller : MonoBehaviour
	{
		...
		// TankRU05 Transforms
		[Header("TankRU05 Transforms")]

			[Tooltip("The tank body transform")]	    
			// _tankRU05Body
			[SerializeField] private Transform _tankRU05Body;

			[Tooltip("The tank turret transform")]	    
			// _tankRU05Turret						
			[SerializeField] private Transform _tankRU05Turret;

			[Tooltip("The tank barrel transform")]	    
			// _tankRU05Barrel					
			[SerializeField] private Transform _tankRU05Barrel;			
		...
		[Header("Amounts")]
			...
			// _tankRU05RotationSpeed is 0.35
			[SerializeField] private float _tankRU05RotationSpeed = 0.35f;
			...
			// Vector3 _tankRU05Rotation
			private Vector3 _tankRU05BodyRotation;

			// Vector3 _tankRU05TurretRotation
			private Vector3 _tankRU05TurretRotation;

		// Speed
		[Header("Speed")]

			[Tooltip("The speed measurement unit")]
			// TankRU05SpeedType _speedType	
			[SerializeField] private TankRU05SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// _tankRU05Rotation is _tankRU05Rotation.transform.eulerAngles
			_tankRU05BodyRotation = _tankRU05Body.transform.eulerAngles;

			// _tankRU05TurretRotation is _tankRU05Turret.transform.eulerAngles
			_tankRU05TurretRotation = _tankRU05Turret.transform.eulerAngles;
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals TankRU05SpeedType.mph
			if (_speedType == TankRU05SpeedType.mph)
			{
			...
			} // close if _speedType equals TankRU05SpeedType.mph

			// else if _speedType equals TankRU05SpeedType.kmh
			else if (_speedType == TankRU05SpeedType.kmh)
			{
			...
			} // close else if _speedType equals TankRU05SpeedType.kmh
		...
		{			
			...
			// _tankRU05Rotation.transform.eulerAngles is _tankRU05Rotation
			_tankRU05Body.transform.eulerAngles = _tankRU05BodyRotation;

			// _tankRU05Rotation.y is Input GetAxis _horizontalMoveInput times _tankRU05RotationSpeed
			_tankRU05BodyRotation.y += Input.GetAxis(_horizontalMoveInput) * _tankRU05RotationSpeed;

			// Take care of the tank turret steering
		
			// _tankRU05Turret.transform.eulerAngles is _tankRU05TurretRotation
			_tankRU05Turret.transform.eulerAngles = _tankRU05TurretRotation;

			// _tankRU05TurretRotation.y is Input GetAxis _mouseXInput times _turretRotationSpeed
			_tankRU05TurretRotation.y += Input.GetAxis(_mouseXInput) * _turretRotationSpeed;
			...
			// _tankRU05Barrel.localRotation is Quaternion Euler _barrelElevation, 0, 0
			_tankRU05Barrel.localRotation = Quaternion.Euler(_barrelElevation, 0, 0);
            
		} // close private void HandleSteering

	} // close public class TankRU05Controller
