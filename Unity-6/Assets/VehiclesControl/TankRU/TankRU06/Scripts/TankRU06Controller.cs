/*
 * File: Tank RU 06 Controller
 * Name: TankRU06Controller.cs
...
namespace VehiclesControl
{
	// public enum TankRU06SpeedType
	public enum TankRU06SpeedType
	{
		mph,
		kmh	

	} // close public enum TankRU06SpeedType
	...
	// public class TankRU06Controller
	public class TankRU06Controller : MonoBehaviour
	{
		...
		// TankRU06 Transforms
		[Header("TankRU06 Transforms")]

			[Tooltip("The tank body transform")]	    
			// _tankRU06Body
			[SerializeField] private Transform _tankRU06Body;

			[Tooltip("The tank turret transform")]	    
			// _tankRU06Turret						
			[SerializeField] private Transform _tankRU06Turret;

			[Tooltip("The tank barrel transform")]	    
			// _tankRU06Barrel					
			[SerializeField] private Transform _tankRU06Barrel;			
		...
		[Header("Amounts")]
			...
			// _tankRU06RotationSpeed is 0.35
			[SerializeField] private float _tankRU06RotationSpeed = 0.35f;
			...
			// Vector3 _tankRU06Rotation
			private Vector3 _tankRU06BodyRotation;

			// Vector3 _tankRU06TurretRotation
			private Vector3 _tankRU06TurretRotation;

		// Speed
		[Header("Speed")]

			[Tooltip("The speed measurement unit")]
			// TankRU06SpeedType _speedType	
			[SerializeField] private TankRU06SpeedType _speedType;			
		...
		private void Awake()
		{
			...
			// _tankRU06Rotation is _tankRU06Rotation.transform.eulerAngles
			_tankRU06BodyRotation = _tankRU06Body.transform.eulerAngles;

			// _tankRU06TurretRotation is _tankRU06Turret.transform.eulerAngles
			_tankRU06TurretRotation = _tankRU06Turret.transform.eulerAngles;
		...
		private void HandleSpeed()
		{
			...
			// _speedType equals TankRU06SpeedType.mph
			if (_speedType == TankRU06SpeedType.mph)
			{
			...
			} // close if _speedType equals TankRU06SpeedType.mph

			// else if _speedType equals TankRU06SpeedType.kmh
			else if (_speedType == TankRU06SpeedType.kmh)
			{
			...
			} // close else if _speedType equals TankRU06SpeedType.kmh
		...
		{			
			...
			// _tankRU06Rotation.transform.eulerAngles is _tankRU06Rotation
			_tankRU06Body.transform.eulerAngles = _tankRU06BodyRotation;

			// _tankRU06Rotation.y is Input GetAxis _horizontalMoveInput times _tankRU06RotationSpeed
			_tankRU06BodyRotation.y += Input.GetAxis(_horizontalMoveInput) * _tankRU06RotationSpeed;

			// Take care of the tank turret steering
		
			// _tankRU06Turret.transform.eulerAngles is _tankRU06TurretRotation
			_tankRU06Turret.transform.eulerAngles = _tankRU06TurretRotation;

			// _tankRU06TurretRotation.y is Input GetAxis _mouseXInput times _turretRotationSpeed
			_tankRU06TurretRotation.y += Input.GetAxis(_mouseXInput) * _turretRotationSpeed;
			...
			// _tankRU06Barrel.localRotation is Quaternion Euler _barrelElevation, 0, 0
			_tankRU06Barrel.localRotation = Quaternion.Euler(_barrelElevation, 0, 0);
            
		} // close private void HandleSteering

	} // close public class TankRU06Controller
